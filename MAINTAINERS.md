...
This document lists the people responsible for maintaining nexcode and defines the project's
...
- A new or promoted provider preset is a credential-destination change. Before merge it needs the
  ...
  catalog](https://nexcode.me/contributing/#evidence-required-for-a-canonical-preset): documented
...
- 2026-08-19 — [@Wibias](https://github.com/Wibias) stepped down as a maintainer
  ...
  nexcode; it is not a disciplinary action, and it was made with the owner's
