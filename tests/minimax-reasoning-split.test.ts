...
type ReasoningEffort = NxcParsedRequest["options"]["reasoning"];

function parsed(modelId: string, reasoning?: ReasoningEffort): NxcParsedRequest {
  return {
    modelId,
...
function body(provider: NxcProviderConfig, modelId: string, reasoning?: ReasoningEffort): Record<string, unknown> {
...
function minimaxRoute(modelId = "MiniMax-M3", provider: Partial<NxcProviderConfig> = {}) {
