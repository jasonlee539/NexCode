...
const generatedBugFix = [
  ...
  "## What's Changed",
  "### Bug Fixes",
  "* fix(api): preserve generated PR coverage by @alice in https://github.com/lidge-jun/nexcode/pull/10",
  "",
  "**Full Changelog**: https://github.com/lidge-jun/nexcode/compare/v1.0.0...v1.1.0",
].join("\n");
...
describe("release metadata parsers", () => {
  ...
  test("parses actual NUL-delimited git-log output without control-byte collisions", () => {
    const repo = mkdtempSync(join(tmpdir(), "nxc-release-log-"));
