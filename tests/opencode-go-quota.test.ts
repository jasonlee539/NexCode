...
function openCodeGoConfig(baseUrl = "https://opencode.ai/zen/go/v1"): NxcConfig {
  return {
...
describe("OpenCode Go provider quota", () => {
  ...
  // meant those rows had no dashboard quota panel and no `nxc provider quota --json` report,
