...
function commandCodeConfig(baseUrl = "https://api.commandcode.ai/provider/v1"): NxcConfig {
  return {
...
function commandCodeOAuthConfig(baseUrl = "https://api.commandcode.ai"): NxcConfig {
  return {
...
beforeEach(() => {
  nexcodeHome = mkdtempSync(join(tmpdir(), "nxc-command-code-quota-"));
