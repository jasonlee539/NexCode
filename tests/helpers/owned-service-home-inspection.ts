 ...
 * NEXCODE_HOME but start a server in THIS process.
 *
 ...
 *
 * On a machine running nxc as a service, that inspection sees a loaded job whose
 ...
 *
 * The failure is invisible in CI (no runner has nxc installed as a service) and
