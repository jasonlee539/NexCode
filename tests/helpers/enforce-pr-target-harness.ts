...
const DEFAULT_PR = {
  ...
  merged: false,
  locked: false,
  html_url: "https://github.com/lidge-jun/nexcode/pull/42",
  base: {
    ref: "dev",
  ...
  head: {
    ...
    repo: { name: "nexcode", owner: { login: "contributor" } },
  },
...
function nodeLikeProcess(): Record<string, unknown> {
  ...
  return {
    ...
    env: {
      ...
      GITHUB_REPOSITORY: "lidge-jun/nexcode",
  ...
  class Context {
    ...
    payload = {
        ...
        ? {
            issue: {
              ...
              ...(options.issueIsPullRequest === false
                ? {}
                : { pull_request: { url: "https://api.github.com/repos/lidge-jun/nexcode/pulls/42" } }),
            },
            comment: {
              id: 424242,
      ...
      repository: {
        id: 987654321,
        name: "nexcode",
        full_name: "lidge-jun/nexcode",
        default_branch: "main",
        private: false,
        owner: { login: "lidge-jun", id: 12345, type: "User" },
        html_url: "https://github.com/lidge-jun/nexcode",
      },
    ...
    get repo() {
      return { owner: "lidge-jun", repo: "nexcode" };
    }
    get issue() {
      return { owner: "lidge-jun", repo: "nexcode", number: eventPr.number };
    }
  }
