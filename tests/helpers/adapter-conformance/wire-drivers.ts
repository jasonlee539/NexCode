...
export interface ToolWireDriver {
  observeOutbound(adapter: ProviderAdapter, parsed: NxcParsedRequest): Promise<string>;
...
async function observeHttpOutbound(adapter: ProviderAdapter, parsed: NxcParsedRequest): Promise<string> {
