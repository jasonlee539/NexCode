...
function umansProvider(apiKey = "sk-umans", apiKeyTransport?: NxcProviderConfig["apiKeyTransport"]): NxcProviderConfig {
  return {
    adapter: "anthropic",
...
function parsedWithWebSearchTool(): NxcParsedRequest {
  return {
    modelId: "umans-coder",
    context: {
