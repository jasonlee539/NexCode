...
beforeEach(() => {
  ...
  isolatedCodexHome = installIsolatedCodexHome("nxc-api-usage-codex-");
  testDir = mkdtempSync(join(tmpdir(), "nxc-api-usage-"));
