...
function config(claudeCode?: NxcConfig["claudeCode"]): NxcConfig {
  return { port: 10100, defaultProvider: "openai", providers: {}, ...(claudeCode ? { claudeCode } : {}) } as unknown as NxcConfig;
}
