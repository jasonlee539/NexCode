...
beforeEach(() => {
  ...
  isolatedCodexHome = installIsolatedCodexHome("nxc-imgretry-e2e-codex-");
  testDir = mkdtempSync(join(tmpdir(), "nxc-imgretry-e2e-"));
...
function anthropicConfig(baseUrl: string, pool = false): NxcConfig {
  return {
    port: 0,
    hostname: "127.0.0.1",
