...
function cfg(providers: Record<string, Partial<NxcProviderConfig>>, disabledModels?: string[]): Pick<NxcConfig, "disabledModels" | "providers"> {
  const full: Record<string, NxcProviderConfig> = {};
