...
function readDiskConfig(): NxcConfig {
  return JSON.parse(readFileSync(getConfigPath(), "utf8")) as NxcConfig;
}

function seedOverlay(): NxcConfig {
...
beforeEach(() => {
  ...
  testDir = mkdtempSync(join(tmpdir(), "nxc-overlay-review-"));
