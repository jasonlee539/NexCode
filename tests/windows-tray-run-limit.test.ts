...
describe("windows tray Run registration (#696)", () => {
  test("short wscript Run command stays within the 260-character Windows limit under long paths", () => {
    ...
    const entry = {
      ...
      script: "C:\\Users\\VeryLongWindowsUserNameForTestingPaths\\.nexcode\\nexcode-tray.ps1",
      codexHome: "C:\\Users\\VeryLongWindowsUserNameForTestingPaths\\.codex",
      nexcodeHome: "C:\\Users\\VeryLongWindowsUserNameForTestingPaths\\.nexcode",
      launcherPath: "C:\\Users\\VeryLongWindowsUserNameForTestingPaths\\.nexcode\\nexcode-tray.vbs",
    };
    ...
    expect(runCommand).toContain("nexcode-tray.vbs");
