...
beforeEach(() => {
  ...
  isolatedCodexHome = installIsolatedCodexHome("nxc-kiro-401-codex-");
  testDir = mkdtempSync(join(tmpdir(), "nxc-kiro-401-"));
  emptyHome = mkdtempSync(join(tmpdir(), "nxc-kiro-401-home-"));
