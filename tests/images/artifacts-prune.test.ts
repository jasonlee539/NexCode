...
beforeAll(() => { process.env.NEXCODE_HOME = join(tmpdir(), "nxc-prune-" + randomUUID()); });
afterAll(() => { if (PREV_HOME === undefined) delete process.env.NEXCODE_HOME; else process.env.NEXCODE_HOME = PREV_HOME; });
