...
function parsedWith(messages: unknown[]): NxcParsedRequest {
  return { modelId: "claude-sonnet-4.5", stream: true, options: {}, context: { messages } } as unknown as NxcParsedRequest;
}
