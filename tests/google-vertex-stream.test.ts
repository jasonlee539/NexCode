...
async function collect(provider: NxcProviderConfig, chunks: unknown[]): Promise<AdapterEvent[]> {
...
const vertexProvider = { adapter: "google", baseUrl: "https://x", googleMode: "vertex" } as NxcProviderConfig;
