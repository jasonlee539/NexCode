...
const routed: NxcProviderConfig = { adapter: "openai-chat", baseUrl: "https://routed.test/v1", apiKey: "routed-key" };
const forward: NxcProviderConfig = { adapter: "openai-responses", baseUrl: "https://chatgpt.test/v1", authMode: "forward" };
...
async function putSidecar(cfg: NxcConfig, webSearch: Record<string, unknown>): Promise<Response> {
...
async function putClaudeCode(cfg: NxcConfig, body: Record<string, unknown>): Promise<Response> {
