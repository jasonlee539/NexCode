...
beforeEach(() => {
  ...
  isolatedCodexHome = installIsolatedCodexHome("nxc-kiro-completion-codex-");
  testDir = mkdtempSync(join(tmpdir(), "nxc-kiro-completion-"));
...
function kiroConfig(baseUrl: string): NxcConfig {
  return {
    port: 0,
    hostname: "127.0.0.1",
