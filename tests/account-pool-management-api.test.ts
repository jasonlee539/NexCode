...
function makeCodexConfig(overrides: Partial<NxcConfig> = {}): NxcConfig {
  return {
    port: 10100,
    providers: {},
...
describe("Anthropic account pool strategy management API", () => {
  ...
  beforeEach(() => {
    ...
    isolatedCodexHome = installIsolatedCodexHome("nxc-pool-mgmt-codex-");
    testDir = mkdtempSync(join(tmpdir(), "nxc-pool-mgmt-"));
