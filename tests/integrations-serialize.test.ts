    ...
    const doc = {
      providers: {
        nexcode: {
          ...
          api_key: "${NEXCODE_HERMES_API_KEY}",
...
describe("renderToml", () => {
  test("round-trips through Bun.TOML.parse", () => {
    const doc = {
      providers: { nexcode: { type: "openai", base_url: "http://127.0.0.1:10100/v1" } },
      models: { "nexcode/a-b": { provider: "nexcode", model: "a/b", max_context_size: 200000 } },
    };
