...
const forward: NxcProviderConfig = { adapter: "openai-responses", baseUrl: "https://chatgpt.com/backend-api/codex", authMode: "forward" };
const xaiOAuth: NxcProviderConfig = { adapter: "openai-responses", baseUrl: "https://api.x.ai/v1", authMode: "oauth" };
const antigravityOAuth: NxcProviderConfig = { adapter: "google-antigravity", baseUrl: "https://daily-cloudcode-pa.googleapis.com", authMode: "oauth" };
const volc: NxcProviderConfig = { adapter: "openai-chat", baseUrl: "https://ark.volces.test/v1", apiKey: "k" };
...
describe("management routes: routed union + coherence", () => {
  async function putVision(cfg: NxcConfig, vision: Record<string, unknown>): Promise<Response> {
