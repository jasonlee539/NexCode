...
function parsed(messages: NxcMessage[], modelId = "claude-opus-4-6-thinking"): NxcParsedRequest {
  return {
    modelId,
    stream: false,
    options: {},
...
async function envelopeContents(p: NxcParsedRequest): Promise<{ role: string; parts: unknown[] }[]> {
