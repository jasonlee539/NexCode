...
describe("responses parser — malformed content blocks", () => {
  ...
  test("adapters build a request from malformed input instead of throwing", async () => {
    ...
    const google = { adapter: "google", baseUrl: "https://generativelanguage.googleapis.com", apiKey: "k" } as unknown as NxcProviderConfig;
    const anthropic = { adapter: "anthropic", baseUrl: "https://api.anthropic.com", apiKey: "sk-x" } as unknown as NxcProviderConfig;
