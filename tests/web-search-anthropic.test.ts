...
const routedProvider: NxcProviderConfig = { adapter: "openai-chat", baseUrl: "https://routed.test/v1", apiKey: "routed-key" };
const forwardProvider: NxcProviderConfig = { adapter: "openai-responses", baseUrl: "https://chatgpt.test/v1", authMode: "forward" };
const anthropicProvider: NxcProviderConfig = { adapter: "anthropic", baseUrl: "https://api.anthropic.com", authMode: "oauth" };
const AUTH_ERROR_CANARY = "C:\\Users\\Alice\\.nexcode\\auth.json.nxc-tmp /home/alice/.nexcode/auth.json.nxc-tmp";
const PUBLIC_OAUTH_ERROR = "OAuth authentication failed. Check the NexCode account status and retry.";
