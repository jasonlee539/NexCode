...
function scratch(): string {
  const dir = mkdtempSync(join(tmpdir(), "nxc-activation-"));
...
function profileConfig(): NxcConfig {
  return { providers: {}, routingProfiles: { p: { candidates: [] } } } as unknown as NxcConfig;
}

const withProfile = profileConfig();
const bare = { providers: {} } as unknown as NxcConfig;
