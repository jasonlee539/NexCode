...
const TEST_DIR = join(tmpdir(), "nxc-conn-test");
...
function baseConfig(providers: NxcConfig["providers"]): NxcConfig {
...
async function probe(config: NxcConfig, name: string): Promise<{ status: number; body: Record<string, unknown> }> {
