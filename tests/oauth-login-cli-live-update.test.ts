...
function keyModeXaiConfig(port = 0): NxcConfig {
  return {
    port,
    hostname: "127.0.0.1",
    defaultProvider: "xai",
...
beforeEach(() => {
  ...
  isolatedCodexHome = installIsolatedCodexHome("nxc-oauth-live-codex-");
  testDir = mkdtempSync(join(tmpdir(), "nxc-oauth-live-"));
