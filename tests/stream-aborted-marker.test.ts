...
// (synthetic 502 + streamAborted), while a client cancellation keeps nexcode's
...
beforeEach(() => {
  ...
  testDir = mkdtempSync(join(tmpdir(), "nxc-stream-aborted-"));
