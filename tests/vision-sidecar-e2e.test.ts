...
beforeEach(() => {
  ...
  isolatedCodexHome = installIsolatedCodexHome("nxc-vision-e2e-codex-");
  testDir = mkdtempSync(join(tmpdir(), "nxc-vision-e2e-"));
...
const CAPTION = "A red square logo with the word NEXCODE in white monospace text.";
