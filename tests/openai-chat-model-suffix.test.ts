...
function parsed(modelId: string): NxcParsedRequest {
  return {
    modelId,
...
function openaiChatProvider(): NxcProviderConfig {
  return {
    adapter: "openai-chat",
...
function routedZaiProvider(): NxcProviderConfig {
...
function anthropicProvider(): NxcProviderConfig {
  return {
    adapter: "anthropic",
    baseUrl: "https://api.z.ai/api/coding/paas/v4",
    apiKey: "test-key",
