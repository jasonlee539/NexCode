...
const effective: NxcProviderConfig = {
  adapter: "openai-chat",
...
const config = { providers: { "ollama-cloud": effective } } as unknown as NxcConfig;
...
const OVERRIDES: NxcProviderConfig = {
  adapter: "openai-chat",
  baseUrl: "https://ollama.com/v1",
  apiKey: "sk-test",
  authMode: "key",
...
const overrideConfig = { providers: { "ollama-cloud": OVERRIDES } } as unknown as NxcConfig;
...
const EXACT_ONLY: NxcProviderConfig = {
...
const exactConfig = { providers: { "ollama-cloud": EXACT_ONLY } } as unknown as NxcConfig;
