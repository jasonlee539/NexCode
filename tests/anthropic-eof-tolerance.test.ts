...
function providerFor(extra: Partial<NxcProviderConfig> = {}): NxcProviderConfig {
  return {
    adapter: "anthropic",
...
async function collect(provider: NxcProviderConfig, events: string[]): Promise<AdapterEvent[]> {
