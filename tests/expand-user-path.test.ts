...
describe("NEXCODE_HOME tilde expansion", () => {
  test("getConfigDir honors NEXCODE_HOME=~/...", () => {
    process.env.NEXCODE_HOME = "~/.nxc-tilde-test";
    expect(getConfigDir()).toBe(join(homedir(), ".nxc-tilde-test"));
  });
});
