...
function gateway(overrides: Partial<NxcProviderConfig> = {}): NxcProviderConfig {
  return {
    adapter: "openai-chat",
...
describe("registry per-model wire defaults", () => {
  function xai(authMode: "oauth" | "key", overrides: Partial<NxcProviderConfig> = {}): NxcProviderConfig {
    return gateway({
  ...
  function deepseek(overrides: Partial<NxcProviderConfig> = {}): NxcProviderConfig {
    return gateway({
