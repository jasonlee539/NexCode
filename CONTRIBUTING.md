...
Thanks for helping with nexcode.

- Start with the canonical guide: [Contributing](https://nexcode.me/contributing/)
- Pull-request quality contract: [Review readiness and author responsibility](https://nexcode.me/contributing/pr-quality/)
