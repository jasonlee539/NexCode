...
// so Starlight must not emit the former /nexcode project-site prefix.
const SITE_URL = "https://nexcode.me";
...
// what makes Google fall back to the domain ("nexcode.me") for the site name.
...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      social: [
        { icon: "github", label: "GitHub", href: "https://github.com/lidge-jun/nexcode" },
      ],
      editLink: {
        baseUrl: "https://github.com/lidge-jun/nexcode/edit/main/docs-site/",
      },
      lastUpdated: true,
