...
description: Créez, modifiez, validez, simulez et supprimez des profils de stratégie de routage depuis le tableau de bord NexCode.
---

L’onglet **Modèles → Routage** du tableau de bord NexCode permet de gérer `config.routingProfiles` sans modifier `config.json` manuellement.
