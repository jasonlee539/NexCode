---
title: Contribuer
description: Développez nexcode — installation, structure, conventions et ajout d’un fournisseur ou d’un adaptateur.
---
...
La documentation publique est publiée sur GitHub Pages à l’adresse <https://nexcode.me/>. Le workflow
...
[lidge-jun/nexcode-go-archive](https://github.com/lidge-jun/nexcode-go-archive).
...
[`MAINTAINERS.md`](https://github.com/lidge-jun/nexcode/blob/main/MAINTAINERS.md). La propriété GitHub
...
`src/providers/derive.ts` alimente cette entrée dans `nxc init`, `nxc provider`, les préréglages du tableau de bord,
...
Une entrée du registre est une promesse entretenue : nexcode fournit la destination à laquelle sera envoyée
...
toujours accéder au service par le flux personnalisé compatible avec OpenAI, sans qu’nexcode annonce un
...
la surface affectée. nexcode privilégie les petits commits vérifiables plutôt que les gros lots.
