...
description: Create, edit, validate, dry-run, and remove routing policy profiles from the NexCode dashboard.
---

The **Models → Routing** tab in the NexCode dashboard can manage `config.routingProfiles` without editing `config.json` by hand.
