...
description: NexCode kontrol panelinden yönlendirme politikası profilleri oluşturun, düzenleyin, doğrulayın, deneme çalıştırması (dry-run) yapın ve kaldırın.
---

NexCode kontrol panelindeki **Modeller → Yönlendirme** sekmesi, `config.json`
