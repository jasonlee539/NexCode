...
const sampleKeys: ApiKeyEntry[] = [
  { id: "k1", name: "alpha", prefix: "nxc_data_aaaaaaaa...", createdAt: "2026-01-01T00:00:00.000Z",
    usage: { requests7d: 2, totalRequests: 5, lastUsedAt: "2026-07-30T00:00:00.000Z" } },
  { id: "k2", name: "beta", prefix: "nxc_data_bbbbbbbb...", createdAt: "2026-01-02T00:00:00.000Z",
...
const FULL_SECRET = "nxc_FULL_SECRET_ONLY_ONCE";
...
test("workspace overview navigation preserves pending secret and resets delete confirm", async () => {
  ...
  expect(container.textContent).toContain("nxc_data_aaaaaaaa...");
