...
const CACHE_KEY = `nxc.startup.page.v1:${API_BASE}`;
...
function atRiskHealth() {
  return {
    ...
    commands: { installService: "nxc service install", repairService: "nxc service repair", installShim: "nxc shim install", restoreNative: "nxc restore" },
  };
}
