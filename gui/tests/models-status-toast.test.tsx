...
beforeEach(() => {
  ...
  testWindow.localStorage.setItem("nxc-models-collapsed:v2", JSON.stringify([]));
  testWindow.sessionStorage.setItem("nxc.models.catalog.v1:http://localhost", JSON.stringify({
    models: [
