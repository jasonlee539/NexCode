...
const ADMIN_TOKEN_DIALOG_ID = "nexcode-admin-token-dialog";
const ADMIN_TOKEN_USERNAME = "NexCode";
 ...
 * password managers can offer save/autofill. NexCode itself still keeps the
