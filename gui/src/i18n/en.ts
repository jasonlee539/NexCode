import { desktopEn } from "./desktop-translations";
...
export const en = {
  ...
  "uptime.minute": "m",
  "uptime.second": "s",
  "nav.startup": "Management Service",
  ...
  // startup health
  "startup.title": "Management service",
  "startup.subtitle": "Control how the local NexCode dashboard and account-management tools start. Codex model requests remain direct.",
  ...
  "startup.summary.native": "Codex requests remain direct",
  "startup.summary.protected": "NexCode management will be available after restart",
  "startup.summary.atRisk": "NexCode management may be unavailable after restart",
  "startup.riskDetail": "The NexCode management service has no persistent startup mechanism.",
  "startup.riskDetailCustomLocal": "Codex points to a custom local gateway. nexcode cannot manage or verify that gateway's restart lifecycle.",
  ...
  "startup.safeDetail": "Management-service startup is configured. Codex request routing is unaffected.",
  "startup.routing": "Codex connection",
  "startup.routing.proxy": "Legacy local proxy",
  ...
  "startup.restartProtection": "Service recovery",
  ...
  "startup.serviceHint": "Starts at login and restarts the management service after a crash.",
  ...
  "startup.shimHint": "Runs nxc ensure when a supported Codex script launcher starts.",
  ...
  "startup.tray.hint": "Install a login tray icon for one-click management-service start, stop, restart, dashboard, and status controls.",
  ...
  "startup.tray.error": "The Windows tray action failed. Check nxc tray status for details.",
  ...
  "startup.codexRuntime.clampHidden": "Some reasoning effort options were hidden because NexCode used Codex {version}.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Some reasoning effort options were hidden because NexCode used Codex {version} (removed: {efforts}).",
  "startup.codexRuntime.olderBinary": "NexCode is using an older Codex binary ({version}). A newer installation is available.",

  // dashboard
  "dash.subtitle": "Manage Codex accounts, model settings, and local integrations. Model requests do not pass through NexCode.",
  ...
  "dash.mem.restart": "Restart management service",
  ...
  "dash.mem.reconnecting": "Management service restarting… waiting to reconnect",
  "dash.mem.restartFailed": "Management-service restart failed. Check that the service is running.",
  "dash.mem.restartNoSupervisor": "No service recovery detected. The management service may stay down unless you start it again.",
  ...
  "dash.cannotConnect": "Cannot connect to the NexCode management service. Is it running?",
  "dash.runStart": "Run {cmd} to start the management service.",
  "dash.stop": "Stop Management Service",
  "dash.stopConfirm": "Stop the NexCode management service? Codex requests will continue directly.",
  "dash.stopFailed": "Failed to stop the management service (HTTP {status}).",
  "dash.maSwitchFailed": "Mode switch failed (HTTP {status}).",
  "dash.maNetworkError": "Network error — is the management service running?",
  "dash.stopping": "Stopping…",
  "dash.actions": "Management Service",
  ...
  "dash.codexAutoStart": "Start nexcode with Codex",
  "dash.codexAutoStartHint": "Allows an installed launcher shim to run nxc ensure. This setting does not install restart protection; check Startup safety for the effective state.",
  ...
  "dash.shadowCallTooltip": "Codex App makes background helper calls for thread title generation, commit message generation, and skill orchestration. The helper model changed across client versions, so nexcode intercepts every model in this set: {models}. Enable this to redirect those calls to your chosen model.",
  ...
  "dash.maintenanceHint": "Refresh Codex's model catalog or install a newer nexcode release.",
  ...
  "dash.projectConfigTitle": "Project Codex config bypasses NexCode",
  "dash.projectConfigHint": "These repo-local settings override the NexCode proxy (e.g. route to OpenCode Go directly). Remove them so ~/.codex/config.toml routing applies in that project.",
  "dash.checkUpdate": "Check update",
  "dash.updateTitle": "Update nexcode",
  "dash.updateDesc": "Check npm for the selected channel, then choose whether to restart the management service after installation.",
  ...
  "dash.updateRestartHint": "Recommended. The current GUI keeps running the old code until the management service restarts.",
  "dash.runUpdate": "Update",
  "dash.updateReconnecting": "Waiting for the restarted management service…",
  "dash.updateStatus.running": "Updating nexcode.",
  "dash.updateStatus.restarting": "Update installed. Restarting management service.",
  ...
  // providers
  "prov.subtitle": "Configure the upstream providers nexcode routes into Codex. Log in with an account, add a provider, or edit the raw config.",
  ...
  "prov.saved": "Saved! Restart the management service to apply.",
  ...
  "oauthTos.anthropicBody": "Directly reusing Claude subscription OAuth tokens through a third-party proxy such as NexCode is not a supported Anthropic integration and may lead to access restrictions. Supported Agent SDK integrations that use Claude subscriptions are separate.",
  "oauthTos.highBody": "NexCode connects {provider} through a third-party OAuth path. Unsupported use may lead to access limits or suspension.",
  "oauthTos.elevatedBody": "NexCode connects {provider} through an unofficial OAuth path. Use the official client when possible; unusual or automated traffic may be treated as abuse and access may be limited or suspended.",
  "oauthTos.saferPath": "Safer option: configure an API key in NexCode instead.",
  ...
  "prov.networkError": "Network error. Check that the management service is running and try again.",
  ...
  "models.subtitle": "Toggle which models Codex sees — native GPT passthrough and routed providers, grouped by provider (click a header to collapse). Hidden models stay off the catalog + model picker but remain directly callable by exact id. Changes apply on the next Codex turn — nexcode invalidates Codex's 5-min model cache so no restart is needed.",
  ...
  "models.networkError": "Network error — is the management service running?",
  "models.loadFail": "Failed to load models — is the management service running?",
  ...
  // subagents
  "sub.subtitle": "Codex's {cmd} advertises only the first 5 models (by priority) as overrides. Pick up to 5 here — native gpt or routed — and nexcode sets their catalog priority so exactly these lead. Any other model is still callable by its exact name; this only controls what's shown.",
  ...
  "sub.networkError": "Network error — is the management service running?",
  "sub.loadFail": "Failed to load models — is the management service running?",
  "sub.loading": "Loading…",
  ...
  "logs.tabLogs": "Logs",
  "logs.tabDebug": "Debug",
  "logs.subtitle": "Recent requests routed through the local nexcode proxy, newest first.",
  ...
  "storage.policy.schedule.startup": "On management-service startup",
  ...
  "modal.networkError": "Network error — is the management service running?",
  ...
  "modal.invalidPreset": "This built-in provider preset is incomplete. Restart the management service and try again.",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.copyDoctor": "Copy nxc doctor",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.subtitle": "Connect clients to nexcode, manage credentials, and restore client configuration.",
  ...
  "integrations.codex.body": "Codex wiring is owned by the proxy service. Starting nexcode applies it; stopping the service restores native routing.",
  ...
  "integrations.detail.grokAbsent": "No nexcode block in the config",
  "integrations.dialog.grok.title": "Disable the Grok Build integration?",
  "integrations.dialog.grok.changes": "Only the block marked by nexcode will be removed from {path}. Content written outside the block will remain unchanged.",
  "integrations.dialog.grok.breakage": "Disabling removes the nexcode model aliases from Grok Build. Models used with your xAI account remain available.",
  "integrations.dialog.grok.undo": "If nexcode is running on a loopback address, turning this back on writes a new block from the models currently available.",
  "integrations.dialog.grok.confirm": "Disable",
  "integrations.dialog.desktop.title": "Disable Claude Desktop integration?",
  "integrations.dialog.desktop.changes": "If {path} contains an nexcode-managed gateway profile, Desktop will first select a new credential-free standard profile, then remove the old profile and backup.",
  "integrations.dialog.desktop.breakage": "Claude Desktop will return to standard Claude instead of models routed through nexcode.",
  "integrations.dialog.desktop.undo": "Turning this back on regenerates the nexcode profile from your saved model assignments.",
  ...
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build can be registered automatically only while nexcode runs on a loopback address. The previous block that pointed to loopback was removed.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build can be registered automatically only while nexcode runs on a loopback address. There was no previous block to remove.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build can be registered automatically only while nexcode runs on a loopback address. Another process wrote a new block in the meantime, so the block now in the file was not created by this request.",
  "integrations.native.error.orphanedMarker": "{path} has an nexcode start marker but no end marker. The file was left unchanged because nexcode cannot determine where its block ends.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop is pointed at standard mode, but old nexcode credential files remain at: {paths}.",
  ...
  "integrations.onboarding": "Applying writes one nexcode provider block after saving a backup. Disable removes only that block, and a retained snapshot can be restored.",
  "integrations.empty.title": "No installed clients were detected",
  "integrations.empty.body": "Install a supported client, then return here to apply nexcode.",
  ...
  "integrations.error.conflict": "The config changed after nexcode wrote it. Nothing was removed.",
  ...
  "integrations.bulk.body": "Only the nexcode-owned block is removed. A pre-write snapshot is kept for each client.",
  ...
  "integrations.semantics.opencode": "Direct disk launches only; nxc opencode environment injection takes precedence.",
  ...
  "integrations.semantics.dsh": "NexCode manages only llm-pi-ai.providers.nexcode in $DSH_HOME/settings.yaml. DSH hot reloads this provider; your default model and deepseek-official stay unchanged. Currently loopback-only; no real credential is written.",
  "integrations.semantics.mcode": "Manages only custom_provider.nexcode. Your default model and MiniMax login stay unchanged.",
  "integrations.semantics.zcode": "Manages only provider.nexcode in ~/.zcode/v2/config.json. Your Z.ai login and other providers stay unchanged. Restart ZCode after changes.",
  "integrations.semantics.prime": "Manages only providers.nexcode in Prime Agent's models.json — ~/.prime/agent unless PRIME_AGENT_CODING_AGENT_DIR redirects it. Your other providers and model overrides stay unchanged. Applies to new sessions.",
  ...
  "codexAuth.switchDesc": "After confirmation, NexCode closes running Codex processes and switches the native login shared by Codex CLI and Codex App.",
  "codexAuth.cacheWarning": "Switching closes running Codex app and CLI processes, then replaces the native Codex login. Save active work first.",
  "codexAuth.setAsNext": "Switch to this account",
  "codexAuth.cancel": "Cancel",
  "codexAuth.switchBack": "Switch back to Main?",
  "codexAuth.switchBackDesc": "After confirmation, NexCode closes running Codex processes and restores the native Codex login saved before account management began.",
  ...
  "codexAuth.catalogRefreshPending": "The change was saved, but the Codex model catalog refresh is pending. Run nxc sync to retry.",
  ...
  "accountPool.strategyDesc": "How NexCode assigns an account to a new/unbound task.",
  ...
  "api.subtitle": "Use generated API keys to access the nexcode proxy from external apps. Keys authenticate via the {authHeader} header; see the table below for what each endpoint accepts.",
  ...
  "api.authLoopback": "Loopback binds (127.0.0.1 or ::1) bypass authentication. Remote binds require a generated nxc_ key or NEXCODE_API_AUTH_TOKEN.",
  ...
  "claude.injectAgentsDesc": "Registers the models picked on the Subagents tab (plus the current default model) as dispatchable Claude Code agents (nxc-*). Applies from the next session.",
  ...
  "claude.smallFastModelNativeWarning": "When unset, NexCode leaves the helper-model overrides unset. Claude Code may use its native Sonnet model, which may incur charges from your native provider.",
  ...
  "cws.howBody": "Ask Codex for the combo's public model name. Without one, the default is combo/<id>. NexCode selects a target and hops only on retryable upstream failures. If no target remains available, the request fails closed instead of using the global default provider.",
  ...
  "grok.subtitle": "Models nexcode has registered in your Grok config.",
  ...
  "grok.notConfiguredHint": "Start or restart the management service with Grok installed and NexCode writes a managed block into:",
