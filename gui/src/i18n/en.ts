...
export const en = {
  ...
  "startup.subtitle": "Verify that Codex can reach nexcode after a restart, before local proxy routing becomes a reconnect loop.",
  ...
  "startup.summary.protected": "nexcode will be available after restart",
  ...
  "startup.safeDetail": "The current routing and startup mechanism are consistent. No manual nxc start should be required after restart.",
  ...
  // dashboard
  "dash.subtitle": "Live status of the local nexcode proxy, its providers, and the models routed into Codex.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "grok.notConfiguredHint": "Start or restart the proxy with Grok installed and nexcode writes a managed block into:",
