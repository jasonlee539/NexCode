...
import { desktopZh } from "./desktop-translations";
...
export const zh: Record<TKey, string> = {
  ...
  "common.loading": "加载中…",
  "common.retry": "重试",
  "auth.adminTokenTitle": "NexCode 管理员令牌 (NEXCODE_ADMIN_AUTH_TOKEN)",
  ...
  // startup health
  "startup.title": "管理服务",
  "startup.subtitle": "管理 NexCode 本地界面和账号工具的启动方式。Codex 模型请求始终直接连接官方服务。",
  "startup.refresh": "刷新",
  ...
  "startup.summary.native": "Codex 请求保持直连",
  "startup.summary.protected": "重启后 NexCode 管理功能会自动可用",
  "startup.summary.atRisk": "重启后 NexCode 管理功能可能不可用",
  "startup.riskDetail": "NexCode 管理服务尚未配置持久启动机制。",
  "startup.riskDetailCustomLocal": "Codex 指向自定义本地网关。nexcode 无法管理或验证该网关的重启生命周期。",
  "startup.riskDetailWindowsShim": "Launcher shim 仅保护受支持的 CLI 脚本；Windows 上的 Codex Desktop 和直接 codex.exe 启动可以绕过它。",
  "startup.safeDetail": "管理服务的启动方式已配置；它不会改变 Codex 的请求路径。",
  "startup.routing": "Codex 连接方式",
  "startup.routing.proxy": "旧版本地代理（待清理）",
  ...
  "startup.restartProtection": "服务恢复",
  ...
  "startup.tray.hint": "登录时启动托盘图标，一键控制管理服务的启动、停止、重启、面板和状态。",
  ...
  "startup.tray.error": "Windows 托盘操作失败。请运行 nxc tray status 查看详情。",
  ...
  "startup.codexRuntime.clampHidden": "部分推理强度选项已隐藏，因为 NexCode 正在使用 Codex {version}。",
  "startup.codexRuntime.clampHiddenWithEfforts": "部分推理强度选项已隐藏，因为 NexCode 正在使用 Codex {version}（已移除：{efforts}）。",
  "startup.codexRuntime.olderBinary": "NexCode 正在使用较旧的 Codex 二进制文件（{version}）。检测到可用的较新安装。",

  // dashboard
  "dash.subtitle": "管理 Codex 账号、模型设置和本地集成；模型请求不会经过 NexCode。",
  ...
  "dash.mem.restart": "重启管理服务",
  "dash.mem.restartConfirm": "等待 {count} 个进行中的请求结束后再重启（最多 {seconds} 秒；超时将中断剩余请求）。",
  "dash.mem.draining": "正在等待 {count} 个请求完成… 完成后重启",
  "dash.mem.reconnecting": "管理服务正在重启… 等待重新连接",
  "dash.mem.restartFailed": "管理服务重启失败。请确认服务正在运行。",
  "dash.mem.restartNoSupervisor": "未检测到服务恢复机制。重启后管理服务可能不会自动恢复，需手动启动。",
  ...
  "dash.cannotConnect": "无法连接到 NexCode 管理服务。它在运行吗？",
  "dash.runStart": "运行 {cmd} 以启动管理服务。",
  "dash.stop": "停止管理服务",
  "dash.stopConfirm": "停止 NexCode 管理服务？Codex 请求仍会保持直连。",
  "dash.stopFailed": "无法停止管理服务 (HTTP {status})。",
  "dash.maSwitchFailed": "模式切换失败 (HTTP {status})。",
  "dash.maNetworkError": "网络错误 — 管理服务是否正在运行？",
  "dash.stopping": "正在停止…",
  "dash.actions": "管理服务",
  ...
  "dash.codexAutoStart": "随 Codex 启动 nexcode",
  "dash.codexAutoStartHint": "允许已安装的 launcher shim 运行 nxc ensure。此设置不会安装重启保护；请在启动安全中检查实际状态。",
  ...
  "dash.shadowCallTooltip": "Codex 应用会在后台调用辅助模型来生成线程标题、提交消息以及进行技能编排。该模型随客户端版本变化，因此 nexcode 会同时拦截这些模型：{models}。启用此选项可将这些调用重定向到您选择的模型。",
  ...
  "dash.effortCapNone": "无上限",
    "dash.maintenance": "维护",
  "dash.maintenanceHint": "刷新 Codex 模型目录，或安装新的 nexcode 版本。",
  ...
  "dash.projectConfigTitle": "项目 Codex 配置绕过了 NexCode",
  "dash.projectConfigHint": "这些仓库级设置会覆盖 NexCode 代理（例如直接走 OpenCode Go）。请移除它们，以便该项目使用 ~/.codex/config.toml 的代理路由。",
  "dash.checkUpdate": "检查更新",
  "dash.updateTitle": "更新 nexcode",
  "dash.updateDesc": "检查所选 npm 频道的最新版本，然后选择安装后是否重启管理服务。",
  ...
  "dash.updateRestartHint": "推荐开启。管理服务重启前，当前 GUI 仍运行旧代码。",
  "dash.runUpdate": "更新",
  "dash.updateReconnecting": "正在等待重启后的管理服务…",
  "dash.updateStatus.running": "正在更新 nexcode。",
  "dash.updateStatus.restarting": "更新已安装。正在重启管理服务。",
  ...
  // providers
  "prov.subtitle": "配置 nexcode 路由到 Codex 的上游提供方。使用账户登录、添加提供方，或编辑原始配置。",
  "prov.add": "添加提供方",
  ...
  "oauthTos.anthropicBody": "通过 NexCode 等第三方代理直接复用 Claude 订阅 OAuth 令牌，并非 Anthropic 支持的集成方式，可能导致访问受限。可使用 Claude 订阅的受支持 Agent SDK 集成属于另一种方式。",
  "oauthTos.highBody": "NexCode 通过第三方 OAuth 路径连接 {provider}。如果该用法不受支持，访问可能会被限制或暂停。",
  "oauthTos.elevatedBody": "NexCode 通过非官方 OAuth 路径连接 {provider}。请尽量使用官方客户端；异常或自动化流量可能被视为滥用，访问可能会被限制或暂停。",
  "oauthTos.saferPath": "更安全的做法：改为在 NexCode 中配置 API 密钥。",
  ...
  "prov.networkError": "网络错误。请确认管理服务正在运行后重试。",
  ...
  "models.subtitle": "开关 Codex 可见的模型 — 原生 GPT passthrough 与已路由模型按提供方分组（点击标题可折叠）。隐藏的模型不会出现在目录和模型选择器中，但仍可按精确 id 直接调用。更改在下一个 Codex 回合生效 — nexcode 会使 Codex 的 5 分钟模型缓存失效，因此无需重启。",
  ...
  "models.networkError": "网络错误 — 管理服务在运行吗？",
  "models.loadFail": "加载模型失败 — 管理服务在运行吗？",
  ...
  // subagents
  "sub.subtitle": "Codex 的 {cmd} 仅将优先级最高的前 5 个模型作为覆盖项公开。在此最多选择 5 个 — 原生 gpt 或已路由模型 — nexcode 会设置它们的目录优先级，使其正好排在前面。其他模型仍可按确切名称调用；此设置仅控制显示项。",
  "sub.featured": "精选",
  ...
  "sub.saveFailed": "保存失败",
  "sub.networkError": "网络错误 — 管理服务在运行吗？",
  "sub.loadFail": "加载模型失败 — 管理服务在运行吗？",
  "sub.loading": "加载中…",
  "sub.moveUp": "上移 {m}",
  "sub.moveDown": "下移 {m}",
  "sub.removeAria": "移除 {m}",
  ...
  "logs.tabLogs": "日志",
  "logs.tabDebug": "调试",
  "logs.subtitle": "经过本地 nexcode 代理的最近请求，最新在前。",
  ...
  "modal.networkError": "网络错误 — 管理服务在运行吗？",
  ...
  "nav.openMenu": "打开菜单",
  "nav.closeMenu": "关闭菜单",
  "integrations.subtitle": "将客户端连接到 nexcode，管理凭据并恢复客户端配置。",
  ...
  "integrations.codex.body": "Codex 连接由代理服务管理。启动 nexcode 时应用该连接；停止服务时恢复原生路由。",
  ...
  "integrations.dialog.desktop.changes": "如果 {path} 包含由 nexcode 管理的网关配置，Desktop 会先选择新的无凭据标准配置，再移除旧配置及其备份。",
  "integrations.dialog.desktop.breakage": "Claude Desktop 将不再使用经由 nexcode 路由的模型，而会恢复为标准 Claude。",
  "integrations.dialog.desktop.undo": "重新开启后，会根据已保存的模型分配重新生成 nexcode 配置。",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop 已指向标准模式，但仍残留旧的 nexcode 凭据文件：{paths}。",
  ...
  "integrations.detail.grokAbsent": "配置中没有 nexcode 区块",
  "integrations.dialog.grok.title": "要停用 Grok Build 集成吗？",
  "integrations.dialog.grok.changes": "只会从 {path} 中删除由 nexcode 标记的区块。区块之外手动写入的内容将保持不变。",
  "integrations.dialog.grok.breakage": "停用后，Grok Build 中的 nexcode 模型别名将消失。通过 xAI 账号使用的模型不受影响。",
  "integrations.dialog.grok.undo": "如果 nexcode 正在 loopback 地址上运行，再次启用时会根据当前可用的模型列表重新写入区块。",
  "integrations.dialog.grok.confirm": "停用",
  "integrations.native.msg.nonLoopbackRemoved": "只有当 nexcode 在 loopback 地址上运行时，才能自动注册 Grok Build。已删除之前指向 loopback 地址的区块。",
  "integrations.native.msg.nonLoopbackRemovedNoop": "只有当 nexcode 在 loopback 地址上运行时，才能自动注册 Grok Build。没有需要删除的旧区块。",
  "integrations.native.msg.nonLoopbackSuperseded": "只有当 nexcode 在 loopback 地址上运行时，才能自动注册 Grok Build。在此期间，其他进程向配置写入了新区块，因此文件中的当前区块并非由本次请求创建。",
  "integrations.native.error.orphanedMarker": "{path} 中有 nexcode 开始标记，但没有结束标记。由于无法确定该区块的结束位置，因此未修改文件。",
  ...
  "integrations.onboarding": "应用时会先保存备份，再写入一个 nexcode 提供方配置块。禁用时只移除该配置块，并可从保留的快照恢复。",
  "integrations.empty.title": "未检测到已安装的客户端",
  "integrations.empty.body": "安装受支持的客户端，然后返回此处应用 nexcode。",
  ...
  "integrations.error.conflict": "nexcode 写入后配置又发生了更改。未移除任何内容。",
  ...
  "integrations.bulk.body": "只会移除归 nexcode 所有的配置块。每个客户端都会先保留一份写入前快照。",
  ...
  "integrations.semantics.opencode": "仅适用于直接从磁盘启动；nxc opencode 的环境注入优先。",
  ...
  "integrations.semantics.dsh": "NexCode 只管理 $DSH_HOME/settings.yaml 中的 llm-pi-ai.providers.nexcode。DSH 会热重载该 provider；你的默认模型和 deepseek-official 保持不变。目前仅支持环回地址，且不会写入真实凭据。",
  "integrations.semantics.mcode": "仅管理 custom_provider.nexcode，不会更改默认模型或 MiniMax 登录状态。",
  "integrations.semantics.zcode": "仅管理 ~/.zcode/v2/config.json 中的 provider.nexcode，不会更改 Z.ai 登录状态或其他提供商。更改后请重启 ZCode。",
  "integrations.semantics.prime": "仅管理 Prime Agent 的 models.json 中的 providers.nexcode；默认位于 ~/.prime/agent，若设置 PRIME_AGENT_CODING_AGENT_DIR 则以其为准。不会更改其他提供商或模型覆盖设置。对新会话生效。",
  ...
  "codexAuth.switchDesc": "确认后会关闭正在运行的 Codex 进程，并切换 Codex CLI 与 Codex 桌面端共同使用的原生登录账号。",
  "codexAuth.cacheWarning": "切换会先关闭正在运行的 Codex 桌面端和 CLI，再替换 Codex 原生登录。请先保存正在进行的工作。",
  "codexAuth.setAsNext": "切换到此账号",
  "codexAuth.cancel": "取消",
  "codexAuth.switchBack": "切换回主账号？",
  "codexAuth.switchBackDesc": "确认后会关闭正在运行的 Codex 进程，并恢复开始管理账号前保存的 Codex 原生登录账号。",
  ...
  "codexAuth.catalogRefreshPending": "更改已保存，但 Codex 模型目录仍待刷新。请运行 nxc sync 重试。",
  ...
  "accountPool.strategyDesc": "NexCode 如何为新建/未绑定任务分配账号。",
  ...
  // api access page
  "api.title": "API 访问",
  "api.subtitle": "用生成的 API 密钥从外部应用访问 nexcode 代理。认证使用 {authHeader} 请求头；各端点接受哪些请求头见下表。",
  ...
  "api.authTitle": "身份验证",
  "api.authLoopback": "回环绑定（127.0.0.1 或 ::1）会跳过身份验证。远程绑定需要生成的 nxc_ 密钥或 NEXCODE_API_AUTH_TOKEN。",
  ...
  "claude.injectAgentsDesc": "将“子代理”页选中的模型（以及当前默认模型）注册为 Claude Code 可派遣的代理（nxc-*）。从下一个会话开始生效。",
  ...
  "claude.smallFastModelNativeWarning": "留空时，NexCode 不会设置辅助模型覆盖项。Claude Code 可能使用其原生 Sonnet 模型，并可能产生原生提供方费用。",
  ...
  "storage.policy.schedule.startup": "管理服务启动时",
  ...
  "modal.badge.free": "免费",
  "modal.invalidPreset": "此内置提供方预设不完整。请重启管理服务后重试。",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.howTitle": "工作原理",
  "cws.howBody": "在 Codex 中请求组合的公开模型名称；未设置时默认使用 combo/<id>。NexCode 仅在可重试的上游错误时切换目标。若没有可用目标，请求会直接失败，不会回退到全局默认提供方。",
  ...
  "grok.subtitle": "nexcode 已注册到你的 Grok 配置中的模型。",
  "grok.loading": "正在加载 Grok 状态…",
  "grok.loadFail": "无法读取 Grok 配置。",
  "grok.notConfiguredTitle": "Grok Build 尚未接入",
  "grok.notConfiguredHint": "安装 Grok 后重启管理服务，NexCode 会把托管块写入：",
  "grok.endpoint": "端点",
  "grok.colModel": "模型",
