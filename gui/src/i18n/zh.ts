...
export const zh: Record<TKey, string> = {
  ...
  // startup health
  "startup.title": "启动安全",
  "startup.subtitle": "检查重启后 Codex 是否仍能连接 nexcode，避免本地代理路由陷入重复重连。",
  "startup.refresh": "刷新",
  ...
  "startup.summary.protected": "重启后 nexcode 会自动可用",
  ...
  "startup.safeDetail": "当前路由与启动机制一致。重启后无需手动运行 nxc start。",
  ...
  // dashboard
  "dash.subtitle": "本地 nexcode 代理、其提供方以及路由到 Codex 的模型的实时状态。",
  ...
  "codexAuth.nativeSwitchDesc": "NexCode 会先关闭正在运行的 Codex 进程，再替换 Codex 原生登录；模型请求仍会直接连接 OpenAI。切换后请重新打开 Codex。",
  "codexAuth.nativeSwitchAction": "切换原生登录账号",
  "codexAuth.nativeSwitched": "Codex 原生登录已切换为 {email}，请重新打开 Codex。",
  "codexAuth.cancel": "取消",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "grok.notConfiguredHint": "安装 Grok 后重启代理，nexcode 会把托管块写入：",
  "grok.endpoint": "端点",
  "grok.colModel": "模型",
