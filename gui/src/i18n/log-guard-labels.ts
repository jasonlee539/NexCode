...
const LABELS: Record<Locale, Record<LogGuardLabelKey, string>> = {
  en: {
    ...
    "error.config_write_failed": "The database changed, but NexCode could not save the protection setting. Fix config storage, then run Repair.",
  },
  de: {
    ...
    "error.config_write_failed": "Die Datenbank wurde geändert, aber NexCode konnte die Schutzeinstellung nicht speichern. Repariere den Konfigurationsspeicher und führe danach Reparieren aus.",
  },
  fr: {
    compact: "Compacter",
    ...
    "error.config_write_failed": "La base de données a été modifiée, mais NexCode n’a pas pu enregistrer le paramètre de protection. Corrigez le stockage de configuration, puis lancez Réparer.",
  },
  ko: {
    compact: '압축',
    ...
    "error.config_write_failed": "데이터베이스는 변경되었지만 NexCode가 보호 설정을 저장하지 못했습니다. 구성 저장소를 수정한 뒤 복구를 실행하세요.",
  },
  zh: {
    compact: '压缩',
    ...
    "error.config_write_failed": "数据库已更改，但 NexCode 无法保存保护设置。请先修复配置存储，然后运行“修复保护”。",
  },
  "zh-TW": {
    compact: '壓縮',
    compactComplete: "压缩完成（逻辑 / 磁盘回收）",
    ...
    "error.config_write_failed": "資料庫已變更，但 NexCode 無法儲存保護設定。請先修復設定儲存空間，再執行「修復保護」。",
  },
  ru: {
    compact: 'Сжать',
    ...
    "error.config_write_failed": "База была изменена, но NexCode не смог сохранить настройку защиты. Исправьте хранилище конфигурации и затем запустите восстановление.",
  },
  ja: {
    compact: '圧縮',
    ...
    "error.config_write_failed": "データベースは変更されましたが、NexCode は保護設定を保存できませんでした。設定ストレージを修正してから保護を修復してください。",
  },
  tr: {
    compact: 'Sıkıştır',
    ...
    "error.config_write_failed": "Veritabanı değişti ancak NexCode koruma ayarını kaydedemedi. Yapılandırma depolamasını düzeltip ardından korumayı onarın.",
  },
};
