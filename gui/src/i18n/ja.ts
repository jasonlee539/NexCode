...
export const ja: Record<TKey, string> = {
  ...
  // startup health
  "startup.title": "起動安全性",
  "startup.subtitle": "再起動後にローカルプロキシへの接続が再接続ループになる前に、Codex が nexcode へ到達できるか確認します。",
  "startup.refresh": "更新",
  ...
  "startup.summary.protected": "再起動後も nexcode を利用できます",
  ...
  "startup.safeDetail": "現在のルーティングと起動方式は整合しています。再起動後に nxc start を手動実行する必要はありません。",
  ...
  // dashboard
  "dash.subtitle": "ローカル nexcode プロキシ、そのプロバイダー、Codex にルーティングされるモデルのライブ状態です。",
  ...
  "codexAuth.nativeSwitchDesc": "NexCode は実行中の Codex プロセスを終了してネイティブの Codex ログインを置き換えます。モデルリクエストは OpenAI に直接接続されたままです。切り替え後に Codex を開き直してください。",
  "codexAuth.cacheWarning": "アカウント切り替えでプロンプトキャッシュはリセットされます。新規セッションは空のキャッシュで開始します。",
  "codexAuth.setAsNext": "このアカウントを次に使う",
  "codexAuth.nativeSwitchAction": "ネイティブログインを切り替える",
  ...
  "codexAuth.nativeSwitched": "{email} が Codex のネイティブログインになりました。Codex を開き直してください。",
  ...
  "grok.notConfiguredHint": "Grok をインストールしてプロキシを再起動すると、nexcode が管理ブロックを次の場所に書き込みます:",
