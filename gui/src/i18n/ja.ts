...
import { desktopJa } from "./desktop-translations";
...
export const ja: Record<TKey, string> = {
  ...
  "common.retry": "再試行",
  "auth.adminTokenTitle": "NexCode 管理者トークン (NEXCODE_ADMIN_AUTH_TOKEN)",
  ...
  // startup health
  "startup.title": "管理サービス",
  "startup.subtitle": "NexCode のローカル画面とアカウント管理ツールの起動方法を管理します。Codex のモデルリクエストは常に直接送信されます。",
  "startup.refresh": "更新",
  ...
  "startup.summary.native": "Codex リクエストは直接送信されます",
  "startup.summary.protected": "再起動後も NexCode の管理機能を利用できます",
  "startup.summary.atRisk": "再起動後に NexCode の管理機能を利用できない可能性があります",
  "startup.riskDetail": "NexCode 管理サービスの永続的な起動方法が設定されていません。",
  "startup.riskDetailCustomLocal": "Codex はカスタムローカルゲートウェイを参照しています。nexcode はその再起動ライフサイクルを管理・検証できません。",
  "startup.riskDetailWindowsShim": "Launcher shim は対応する CLI スクリプトのみを保護し、Windows の Codex Desktop と codex.exe の直接起動はこれを迂回できます。",
  "startup.safeDetail": "管理サービスの起動方法は設定済みです。Codex のリクエスト経路には影響しません。",
  "startup.routing": "Codex の接続方式",
  "startup.routing.proxy": "旧ローカルプロキシ",
  ...
  "startup.restartProtection": "サービス復旧",
  ...
  "startup.serviceHint": "ログイン時に起動し、異常終了後に管理サービスを再起動します。",
  "startup.installed": "インストール済み",
  "startup.notInstalled": "未インストール",
  "startup.unsupported": "未対応",
  "startup.shim": "Codex launcher shim",
  "startup.shimHint": "対応する Codex スクリプトランチャーの起動時に nxc ensure を実行します。",
  "startup.healthy": "正常",
  ...
  "startup.tray.hint": "ログイン時にトレイを起動し、管理サービスの開始・停止・再起動・ダッシュボード・状態を操作します。",
  ...
  "startup.tray.error": "Windows トレイ操作に失敗しました。nxc tray status で詳細を確認してください。",
  ...
  "startup.codexRuntime.clampHidden": "NexCode が Codex {version} を使用したため、一部の reasoning effort オプションが非表示になりました。",
  "startup.codexRuntime.clampHiddenWithEfforts": "NexCode が Codex {version} を使用したため、一部の reasoning effort オプションが非表示になりました（削除: {efforts}）。",
  "startup.codexRuntime.olderBinary": "NexCode は古い Codex バイナリ（{version}）を使用しています。より新しいインストールが利用可能です。",

  // dashboard
  "dash.subtitle": "Codex アカウント、モデル設定、ローカル連携を管理します。モデルリクエストは NexCode を経由しません。",
  ...
  "dash.mem.reconnecting": "管理サービスを再起動中… 再接続を待機",
  "dash.mem.restartFailed": "管理サービスの再起動に失敗しました。サービスが起動しているか確認してください。",
  "dash.mem.restartNoSupervisor": "サービス復旧がありません。管理サービスを手動で再起動する必要がある場合があります。",
  ...
  "dash.cannotConnect": "NexCode 管理サービスに接続できません。起動していますか?",
  "dash.runStart": "{cmd} を実行して管理サービスを起動してください。",
  "dash.stop": "管理サービスを停止",
  "dash.stopConfirm": "NexCode 管理サービスを停止しますか? Codex リクエストは引き続き直接送信されます。",
  "dash.stopFailed": "管理サービスを停止できませんでした (HTTP {status})。",
  "dash.maSwitchFailed": "モードの切り替えに失敗しました (HTTP {status})。",
  "dash.maNetworkError": "ネットワークエラー — 管理サービスは起動していますか?",
  "dash.stopping": "停止中…",
  "dash.actions": "管理サービス",
  ...
  "dash.codexAutoStart": "Codex と一緒に nexcode を起動",
  "dash.codexAutoStartHint": "インストール済み launcher shim に nxc ensure の実行を許可します。この設定だけでは再起動保護はインストールされません。起動安全性で実際の状態を確認してください。",
  ...
  "dash.shadowCallTooltip": "Codex App はスレッドタイトル生成、コミットメッセージ生成、スキルオーケストレーションをバックグラウンドで呼び出します。使われるモデルはクライアントのバージョンによって変わるため、nexcode は {models} をまとめて傍受します。これをオンにすると、それらの呼び出しを選択したモデルにリダイレクトします。",
  ...
  "dash.maintenanceHint": "Codex のモデルカタログを更新するか、より新しい nexcode リリースをインストールします。",
  ...
  "dash.projectConfigTitle": "プロジェクトの Codex 設定が NexCode をバイパスします",
  "dash.projectConfigHint": "これらのリポジローカル設定は NexCode プロキシを上書きします(例: OpenCode Go に直接ルーティング)。~/.codex/config.toml のルーティングがそのプロジェクトで適用されるように削除してください。",
  "dash.checkUpdate": "更新を確認",
  "dash.updateTitle": "nexcode を更新",
  "dash.updateDesc": "選択したチャンネルの npm を確認し、インストール後に管理サービスを再起動するか選択します。",
  ...
  "dash.updateRestartHint": "推奨。管理サービスが再起動されるまで現在の GUI は古いコードを実行し続けます。",
  "dash.runUpdate": "更新",
  "dash.updateReconnecting": "再起動した管理サービスを待機中…",
  "dash.updateStatus.running": "nexcode を更新しています。",
  "dash.updateStatus.restarting": "更新をインストールしました。管理サービスを再起動中。",
  ...
  // providers
  "prov.subtitle": "nexcode が Codex にルーティングする上流プロバイダーを設定します。アカウントでログインするか、プロバイダーを追加、または生の設定を編集します。",
  "prov.add": "プロバイダーを追加",
  ...
  "prov.saved": "保存しました! 適用には管理サービスを再起動してください。",
  ...
  "oauthTos.anthropicBody": "NexCode のような第三者プロキシ経由で Claude サブスクリプションの OAuth トークンを直接再利用することは、Anthropic がサポートする統合ではなく、アクセス制限につながる可能性があります。Claude サブスクリプションを使用するサポートされた Agent SDK 統合は別物です。",
  "oauthTos.highBody": "NexCode は第三者 OAuth パス経由で {provider} に接続します。サポート外の利用はアクセス制限や停止につながる可能性があります。",
  "oauthTos.elevatedBody": "NexCode は非公式 OAuth パス経由で {provider} に接続します。可能な場合は公式クライアントを使用してください。異常または自動化されたトラフィックは悪用とみなされ、アクセスが制限または停止される可能性があります。",
  "oauthTos.saferPath": "より安全な選択肢: 代わりに NexCode で API キーを設定してください。",
  ...
  "prov.networkError": "ネットワークエラーです。管理サービスが実行中であることを確認して、もう一度試してください。",
  ...
  "models.subtitle": "Codex に表示するモデルを切り替えます — ネイティブ GPT パススルーとルーティングプロバイダー、プロバイダー別(ヘッダーをクリックで折りたたみ)。非表示モデルはカタログとピッカーから外れますが、正確な id での直接呼び出しは可能です。変更は次回の Codex ターンで適用 — nexcode は Codex の 5 分間モデルキャッシュを無効化するので再起動は不要です。",
  ...
  "models.networkError": "ネットワークエラー — 管理サービスは起動していますか?",
  "models.loadFail": "モデルの読み込みに失敗しました — 管理サービスは起動していますか?",
  ...
  // subagents
  "sub.subtitle": "Codex の {cmd} は最初の 5 モデル(優先度順)のみをオーバーライドとして通知します。ここで最大 5 つを選んでください — ネイティブ gpt またはルーティング — nexcode がカタログ優先度を設定し、これらが先頭に来るようにします。他のモデルも正確な名前で呼び出し可能です; これは表示のみを制御します。",
  "sub.featured": "おすすめ",
  ...
  "sub.networkError": "ネットワークエラー — 管理サービスは起動していますか?",
  "sub.loadFail": "モデルの読み込みに失敗しました — 管理サービスは起動していますか?",
  "sub.loading": "読み込み中…",
  "sub.moveUp": "{m} を上へ移動",
  ...
  "logs.tabLogs": "ログ",
  "logs.tabDebug": "デバッグ",
  "logs.subtitle": "ローカル nexcode プロキシを経由した最近のリクエスト(新しい順)。",
  ...
  "storage.policy.schedule.startup": "管理サービス起動時",
  ...
  "modal.networkError": "ネットワークエラー — 管理サービスは起動していますか?",
  ...
  "modal.badge.free": "無料",
  "modal.invalidPreset": "この組み込みプロバイダープリセットは不完全です。管理サービスを再起動してもう一度お試しください。",
  ...
  "pws.copyDoctor": "nxc doctor をコピー",
  ...
  "integrations.subtitle": "クライアントを nexcode に接続し、認証情報の管理とクライアント設定の復元を行います。",
  ...
  "integrations.codex.body": "Codex の接続はプロキシサービスが管理します。nexcode を起動すると適用され、サービスを停止するとネイティブのルーティングに戻ります。",
  ...
  "integrations.dialog.desktop.changes": "{path} に nexcode 管理のゲートウェイプロファイルがある場合、Desktop は先に認証情報のない標準プロファイルを選択し、その後で古いプロファイルとバックアップを削除します。",
  "integrations.dialog.desktop.breakage": "Claude Desktop は nexcode 経由のモデルではなく、標準の Claude に戻ります。",
  "integrations.dialog.desktop.undo": "再度有効にすると、保存済みのモデル割り当てから nexcode プロファイルを再生成します。",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop は標準モードを指していますが、古い nexcode 認証情報ファイルが残っています: {paths}。",
  ...
  "integrations.detail.grokAbsent": "設定に nexcode ブロックがありません",
  "integrations.dialog.grok.title": "Grok Build 連携を解除しますか？",
  "integrations.dialog.grok.changes": "{path} から、nexcode が印を付けたブロックだけを削除します。ブロック外に直接書いた内容はそのまま残します。",
  "integrations.dialog.grok.breakage": "解除すると、Grok Build から nexcode のモデルエイリアスが消えます。xAI アカウントで使用していたモデルはそのままです。",
  "integrations.dialog.grok.undo": "nexcode が loopback アドレスで実行中なら、再び有効にしたとき、現在利用できるモデル一覧からブロックを新しく書き込みます。",
  "integrations.dialog.grok.confirm": "解除",
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build を自動登録できるのは、nexcode が loopback アドレスで実行中の場合だけです。loopback アドレスを指していた以前のブロックを削除しました。",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build を自動登録できるのは、nexcode が loopback アドレスで実行中の場合だけです。削除する以前のブロックはありませんでした。",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build を自動登録できるのは、nexcode が loopback アドレスで実行中の場合だけです。その間に別の場所から設定へ新しいブロックが書かれたため、現在ファイルにあるブロックはこのリクエストが作成したものではありません。",
  "integrations.native.error.orphanedMarker": "{path} に nexcode の開始マーカーはありますが、終了マーカーがありません。ブロックの終端を特定できないため、ファイルは変更していません。",
  ...
  "integrations.onboarding": "適用時は、先にバックアップを保存してから nexcode プロバイダーブロックを 1 つだけ書き込みます。無効化時はそのブロックだけを削除し、保存されたスナップショットから復元できます。",
  "integrations.empty.title": "インストール済みのクライアントが検出されませんでした",
  "integrations.empty.body": "対応クライアントをインストールしてから、ここに戻って nexcode を適用してください。",
  ...
  "integrations.error.conflict": "nexcode の書き込み後に設定が変更されました。何も削除していません。",
  ...
  "integrations.bulk.body": "nexcode が所有するブロックだけを削除します。各クライアントについて、変更前のスナップショットを保存します。",
  ...
  "integrations.semantics.opencode": "ディスクから直接起動した場合にのみ適用されます。nxc opencode の環境注入が優先されます。",
  ...
  "integrations.semantics.dsh": "NexCode が管理するのは $DSH_HOME/settings.yaml 内の llm-pi-ai.providers.nexcode だけです。DSH はこのプロバイダーをホットリロードし、既定のモデルと deepseek-official は変更しません。現在はループバック専用で、実際の認証情報は書き込みません。",
  "integrations.semantics.mcode": "custom_provider.nexcode のみを管理します。既定モデルと MiniMax ログインは変更しません。",
  "integrations.semantics.zcode": "~/.zcode/v2/config.json の provider.nexcode のみを管理します。Z.ai ログインと他のプロバイダーは変更しません。変更後は ZCode を再起動してください。",
  "integrations.semantics.prime": "Prime Agent の models.json 内の providers.nexcode のみを管理します。場所は ~/.prime/agent ですが、PRIME_AGENT_CODING_AGENT_DIR が設定されている場合はそちらが優先されます。他のプロバイダーとモデルオーバーライドは変更しません。新しいセッションから適用されます。",
  ...
  "codexAuth.switchDesc": "確認後、実行中の Codex プロセスを終了し、Codex CLI と Codex App が共有するネイティブログインを切り替えます。",
  "codexAuth.cacheWarning": "切り替えると実行中の Codex アプリと CLI を終了し、Codex のネイティブログインを置き換えます。先に作業を保存してください。",
  "codexAuth.setAsNext": "このアカウントに切り替える",
  "codexAuth.cancel": "キャンセル",
  "codexAuth.switchBack": "メインに戻しますか?",
  "codexAuth.switchBackDesc": "確認後、実行中の Codex プロセスを終了し、アカウント管理前に保存した Codex のネイティブログインを復元します。",
  ...
  "codexAuth.catalogRefreshPending": "変更は保存されましたが、Codex モデルカタログの更新が保留中です。nxc sync を実行して再試行してください。",
  ...
  "accountPool.strategyDesc": "NexCode が新規/未紐付けタスクへアカウントを割り当てる方法です。",
  ...
  // api access page
  "api.title": "API アクセス",
  "api.subtitle": "生成した API キーで外部アプリから nexcode プロキシに接続します。認証は {authHeader} ヘッダーで行い、エンドポイントごとに受け付けるヘッダーは下の表のとおりです。",
  ...
  "api.authLoopback": "ループバック (127.0.0.1 または ::1) は認証を省略します。リモートでは生成した nxc_ キーまたは NEXCODE_API_AUTH_TOKEN が必要です。",
  ...
  "claude.injectAgentsDesc": "サブエージェントタブで選んだモデル(と現在のデフォルトモデル)をディスパッチ可能な Claude Code エージェント(nxc-*)として登録します。次回セッションから適用されます。",
  ...
  "claude.smallFastModelNativeWarning": "未設定の場合、NexCode はヘルパーモデルの上書きを設定しません。Claude Code がネイティブの Sonnet モデルを使用し、ネイティブプロバイダーで料金が発生する可能性があります。",
  ...
  "grok.subtitle": "nexcode が Grok 設定に登録したモデルです。",
  "grok.loading": "Grok の状態を読み込み中…",
  "grok.loadFail": "Grok 設定を読み取れませんでした。",
  "grok.notConfiguredTitle": "Grok Build が未設定です",
  "grok.notConfiguredHint": "Grok をインストールして管理サービスを再起動すると、NexCode が管理ブロックを次の場所に書き込みます:",
  ...
  "cws.howTitle": "仕組み",
  "cws.howBody": "Codex に combo/<id> を要求します。NexCode はターゲットを選び、再試行可能な上流の失敗時のみホップします。利用可能なターゲットが残っていない場合、グローバルなデフォルトプロバイダーを使わずにフェイルクローズします。",
