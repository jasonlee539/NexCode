...
export const ru: Record<TKey, string> = {
  ...
  "startup.subtitle": "Проверьте, сможет ли Codex подключиться к nexcode после перезагрузки, прежде чем локальный прокси вызовет бесконечное переподключение.",
  ...
  "startup.summary.protected": "nexcode будет доступен после перезагрузки",
  ...
  "startup.safeDetail": "Маршрутизация и механизм запуска согласованы. После перезагрузки ручной запуск nxc start не требуется.",
  ...
  // dashboard
  "dash.subtitle": "Актуальное состояние локального прокси nexcode, его провайдеров и моделей, маршрутизируемых в Codex.",
  ...
  "codexAuth.nativeSwitchDesc": "NexCode завершит работающие процессы Codex, заменит нативный вход Codex и сохранит прямое подключение запросов моделей к OpenAI. После переключения снова откройте Codex.",
  ...
  "codexAuth.nativeSwitchAction": "Сменить нативный вход",
  ...
  "codexAuth.nativeSwitched": "{email} теперь используется для нативного входа Codex. Снова откройте Codex.",
  ...
  "grok.notConfiguredHint": "Установите Grok и перезапустите прокси — nexcode запишет управляемый блок в:",
