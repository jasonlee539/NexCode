...
export const de: Record<TKey, string> = {
  ...
  "startup.subtitle": "Prüft, ob Codex nexcode nach einem Neustart erreicht, bevor lokales Proxy-Routing in einer Wiederverbindungsschleife endet.",
  ...
  "startup.summary.protected": "nexcode ist nach einem Neustart verfügbar",
  ...
  "startup.safeDetail": "Routing und Startmechanismus stimmen überein. Nach einem Neustart sollte kein manuelles nxc start nötig sein.",
  ...
  "dash.subtitle": "Live-Status des lokalen nexcode-Proxys, seiner Anbieter und der in Codex gerouteten Modelle.",
  ...
  "codexAuth.nativeSwitchDesc": "NexCode beendet laufende Codex-Prozesse, ersetzt die native Codex-Anmeldung und lässt Modellanfragen direkt mit OpenAI verbunden. Öffne Codex danach erneut.",
  ...
  "codexAuth.nativeSwitchAction": "Native Anmeldung wechseln",
  ...
  "codexAuth.nativeSwitched": "{email} ist jetzt die native Codex-Anmeldung. Öffne Codex erneut.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "grok.notConfiguredHint": "Starte den Proxy mit installiertem Grok neu; nexcode schreibt dann einen verwalteten Block nach:",
