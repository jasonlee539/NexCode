...
import { desktopDe } from "./desktop-translations";
...
export const de: Record<TKey, string> = {
  ...
  "auth.adminTokenTitle": "NexCode-Admin-Token (NEXCODE_ADMIN_AUTH_TOKEN)",
  ...
  "startup.title": "Verwaltungsdienst",
  "startup.subtitle": "Verwalten Sie den Start der lokalen NexCode-Oberfläche und der Kontowerkzeuge. Codex-Modellanfragen bleiben direkt.",
  ...
  "startup.summary.native": "Codex-Anfragen bleiben direkt",
  "startup.summary.protected": "Die NexCode-Verwaltung ist nach einem Neustart verfügbar",
  "startup.summary.atRisk": "Die NexCode-Verwaltung ist nach einem Neustart möglicherweise nicht verfügbar",
  "startup.riskDetail": "Für den NexCode-Verwaltungsdienst ist kein dauerhafter Startmechanismus eingerichtet.",
  "startup.riskDetailCustomLocal": "Codex verwendet ein benutzerdefiniertes lokales Gateway. nexcode kann dessen Neustart-Lebenszyklus weder verwalten noch prüfen.",
  ...
  "startup.safeDetail": "Der Start des Verwaltungsdienstes ist eingerichtet. Das Routing von Codex-Anfragen bleibt unverändert.",
  "startup.routing": "Codex-Verbindung",
  "startup.routing.proxy": "Veralteter lokaler Proxy",
  ...
  "startup.restartProtection": "Dienstwiederherstellung",
  ...
  "startup.serviceHint": "Startet bei der Anmeldung und startet den Verwaltungsdienst nach einem Absturz neu.",
  ...
  "startup.shimHint": "Führt nxc ensure aus, wenn ein unterstützter Codex-Skript-Launcher startet.",
  ...
  "startup.tray.hint": "Installiert ein Anmeldesymbol für Start, Stopp, Neustart, Dashboard und Status des Verwaltungsdienstes.",
  ...
  "startup.tray.error": "Die Windows-Infobereichsaktion ist fehlgeschlagen. Details: nxc tray status.",
  ...
  "startup.codexRuntime.clampHidden": "Einige Reasoning-Effort-Optionen wurden ausgeblendet, weil NexCode Codex {version} verwendet hat.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Einige Reasoning-Effort-Optionen wurden ausgeblendet, weil NexCode Codex {version} verwendet hat (entfernt: {efforts}).",
  "startup.codexRuntime.olderBinary": "NexCode verwendet eine ältere Codex-Binary ({version}). Eine neuere Installation ist verfügbar.",
  "dash.subtitle": "Verwalten Sie Codex-Konten, Modelleinstellungen und lokale Integrationen. Modellanfragen laufen nicht über NexCode.",
  ...
  "dash.mem.restart": "Verwaltungsdienst neu starten",
  ...
  "dash.mem.reconnecting": "Verwaltungsdienst wird neu gestartet… warte auf Verbindung",
  "dash.mem.restartFailed": "Neustart des Verwaltungsdienstes fehlgeschlagen. Prüfen Sie, ob der Dienst läuft.",
  "dash.mem.restartNoSupervisor": "Keine Dienstwiederherstellung erkannt. Der Verwaltungsdienst muss möglicherweise manuell gestartet werden.",
  ...
  "dash.cannotConnect": "Keine Verbindung zum NexCode-Verwaltungsdienst. Läuft er?",
  "dash.runStart": "Führe {cmd} aus, um den Verwaltungsdienst zu starten.",
  "dash.stop": "Verwaltungsdienst stoppen",
  "dash.stopConfirm": "NexCode-Verwaltungsdienst stoppen? Codex-Anfragen bleiben direkt.",
  "dash.stopFailed": "Verwaltungsdienst konnte nicht gestoppt werden (HTTP {status}).",
  "dash.maSwitchFailed": "Moduswechsel fehlgeschlagen (HTTP {status}).",
  "dash.maNetworkError": "Netzwerkfehler — läuft der Verwaltungsdienst?",
  "dash.stopping": "Wird gestoppt…",
  "dash.actions": "Verwaltungsdienst",
  ...
  "dash.codexAutoStart": "nexcode mit Codex starten",
  "dash.codexAutoStartHint": "Erlaubt einem installierten Launcher-Shim, nxc ensure auszuführen. Diese Einstellung installiert keinen Neustartschutz; prüfe den effektiven Zustand unter Startsicherheit.",
  ...
  "dash.shadowCallTooltip": "Die Codex-App ruft im Hintergrund ein Hilfsmodell für Titelgenerierung, Commit-Nachrichten und Skill-Orchestrierung auf. Das Modell wechselt zwischen Client-Versionen, daher fängt nexcode diesen Satz ab: {models}.",
  ...
  "dash.maintenanceHint": "Aktualisiere Codex’ Modellkatalog oder installiere eine neuere nexcode-Version.",
  ...
  "dash.projectConfigTitle": "Projekt-Codex-Konfig umgeht NexCode",
  "dash.projectConfigHint": "Diese repo-lokalen Einstellungen überschreiben den NexCode-Proxy (z. B. direkt zu OpenCode Go routen). Entferne sie, damit die Routing aus ~/.codex/config.toml in diesem Projekt greift.",
  "dash.checkUpdate": "Update prüfen",
  "dash.updateTitle": "nexcode aktualisieren",
  "dash.updateDesc": "Prüfe npm auf den ausgewählten Kanal und wähle dann, ob der Verwaltungsdienst nach der Installation neu gestartet wird.",
  ...
  "dash.updateRestartHint": "Empfohlen. Die aktuelle GUI läuft weiter mit altem Code, bis der Verwaltungsdienst neu startet.",
  "dash.runUpdate": "Aktualisieren",
  "dash.updateReconnecting": "Warten auf den neu gestarteten Verwaltungsdienst…",
  "dash.updateStatus.running": "nexcode wird aktualisiert.",
  "dash.updateStatus.restarting": "Update installiert. Verwaltungsdienst wird neu gestartet.",
  ...
  "prov.subtitle": "Konfiguriere die Upstream-Anbieter, die nexcode in Codex routet. Melde dich mit einem Konto an, füge einen Anbieter hinzu oder bearbeite die Rohkonfiguration.",
  ...
  "prov.saved": "Gespeichert! Verwaltungsdienst neu starten, um anzuwenden.",
  ...
  "oauthTos.anthropicBody": "Die direkte Wiederverwendung von Claude-Abo-OAuth-Tokens über einen Drittanbieter-Proxy wie NexCode ist keine von Anthropic unterstützte Integration und kann zu Zugriffsbeschränkungen führen. Unterstützte Agent-SDK-Integrationen, die Claude-Abos verwenden, sind davon getrennt.",
  "oauthTos.highBody": "NexCode verbindet {provider} über einen OAuth-Pfad eines Drittanbieters. Bei nicht unterstützter Nutzung kann der Zugriff eingeschränkt oder gesperrt werden.",
  "oauthTos.elevatedBody": "NexCode verbindet {provider} über einen inoffiziellen OAuth-Pfad. Nutze nach Möglichkeit den offiziellen Client; ungewöhnlicher oder automatisierter Traffic kann als Missbrauch gewertet und der Zugriff eingeschränkt oder gesperrt werden.",
  "oauthTos.saferPath": "Sicherere Option: Hinterlege stattdessen einen API-Schlüssel in NexCode.",
  ...
  "prov.networkError": "Netzwerkfehler. Prüfe, ob der Verwaltungsdienst läuft, und versuche es erneut.",
  ...
  "models.networkError": "Netzwerkfehler — läuft der Verwaltungsdienst?",
  "models.loadFail": "Modelle konnten nicht geladen werden — läuft der Verwaltungsdienst?",
  ...
  "sub.subtitle": "Codex {cmd} bewirbt nur die ersten 5 Modelle (nach Priorität) als Overrides. Wähle hier bis zu 5 — natives gpt oder geroutet — und nexcode setzt ihre Katalog-Priorität, sodass genau diese führen. Jedes andere Modell bleibt über seinen exakten Namen aufrufbar; dies steuert nur die Anzeige.",
  ...
  "sub.networkError": "Netzwerkfehler — läuft der Verwaltungsdienst?",
  "sub.loadFail": "Modelle konnten nicht geladen werden — läuft der Verwaltungsdienst?",
  "sub.loading": "Lädt…",
  ...
  "logs.subtitle": "Letzte Anfragen über den lokalen nexcode-Proxy, neueste zuerst.",
  ...
  "modal.networkError": "Netzwerkfehler — läuft der Verwaltungsdienst?",
  ...
  "integrations.subtitle": "Clients mit nexcode verbinden, Zugangsdaten verwalten und Client-Konfigurationen wiederherstellen.",
  ...
  "integrations.codex.body": "Die Codex-Anbindung wird vom Proxy-Dienst verwaltet. Beim Start von nexcode wird sie angewendet; beim Stoppen des Dienstes wird das native Routing wiederhergestellt.",
  ...
  "integrations.dialog.desktop.changes": "Falls {path} ein von nexcode verwaltetes Gateway-Profil enthält, wählt Desktop zuerst ein neues Standardprofil ohne Zugangsdaten und entfernt danach das alte Profil und dessen Sicherung.",
  "integrations.dialog.desktop.breakage": "Claude Desktop verwendet dann statt über nexcode gerouteter Modelle wieder das standardmäßige Claude.",
  "integrations.dialog.desktop.undo": "Beim erneuten Aktivieren wird das nexcode-Profil aus deinen gespeicherten Modellzuweisungen neu erstellt.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop zeigt auf den Standardmodus, aber alte nexcode-Zugangsdaten befinden sich noch unter: {paths}.",
  ...
  "integrations.detail.grokAbsent": "Kein nexcode-Block in der Konfiguration",
  "integrations.dialog.grok.title": "Grok-Build-Integration deaktivieren?",
  "integrations.dialog.grok.changes": "Aus {path} wird nur der von nexcode markierte Block entfernt. Manuell geschriebener Inhalt außerhalb des Blocks bleibt unverändert.",
  "integrations.dialog.grok.breakage": "Nach dem Deaktivieren verschwinden die nexcode-Modellaliase aus Grok Build. Modelle, die mit dem xAI-Konto verwendet wurden, bleiben erhalten.",
  "integrations.dialog.grok.undo": "Wenn nexcode unter einer Loopback-Adresse läuft, wird beim erneuten Aktivieren ein neuer Block aus der aktuell verfügbaren Modellliste geschrieben.",
  "integrations.dialog.grok.confirm": "Deaktivieren",
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build kann nur automatisch registriert werden, wenn nexcode unter einer Loopback-Adresse läuft. Der vorherige Block mit Verweis auf Loopback wurde entfernt.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build kann nur automatisch registriert werden, wenn nexcode unter einer Loopback-Adresse läuft. Es gab keinen vorherigen Block zu entfernen.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build kann nur automatisch registriert werden, wenn nexcode unter einer Loopback-Adresse läuft. Inzwischen hat eine andere Stelle einen neuen Block in die Konfiguration geschrieben; der aktuelle Block in der Datei wurde daher nicht von dieser Anfrage erstellt.",
  "integrations.native.error.orphanedMarker": "{path} enthält eine nexcode-Startmarkierung, aber keine Endmarkierung. Die Datei wurde nicht geändert, weil das Ende des Blocks nicht sicher bestimmt werden kann.",
  ...
  "integrations.onboarding": "Beim Anwenden wird nach dem Speichern einer Sicherung genau ein nexcode-Anbieterblock geschrieben. Beim Deaktivieren wird nur dieser Block entfernt; eine aufbewahrte Momentaufnahme kann wiederhergestellt werden.",
  "integrations.empty.title": "Keine installierten Clients erkannt",
  "integrations.empty.body": "Installiere einen unterstützten Client und kehre dann hierher zurück, um nexcode anzuwenden.",
  ...
  "integrations.error.conflict": "Die Konfiguration wurde geändert, nachdem nexcode sie geschrieben hatte. Es wurde nichts entfernt.",
  ...
  "integrations.bulk.body": "Nur der nexcode-eigene Block wird entfernt. Für jeden Client wird vorher eine Momentaufnahme gespeichert.",
  ...
  "integrations.semantics.opencode": "Gilt nur für direkte Starts von der Festplatte; die Umgebungsinjektion von nxc opencode hat Vorrang.",
  ...
  "integrations.semantics.dsh": "NexCode verwaltet nur llm-pi-ai.providers.nexcode in $DSH_HOME/settings.yaml. DSH lädt diesen Anbieter im laufenden Betrieb neu; Ihr Standardmodell und deepseek-official bleiben unverändert. Derzeit nur über Loopback; es werden keine echten Zugangsdaten geschrieben.",
  "integrations.semantics.mcode": "Verwaltet nur custom_provider.nexcode. Standardmodell und MiniMax-Anmeldung bleiben unverändert.",
  "integrations.semantics.zcode": "Verwaltet nur provider.nexcode in ~/.zcode/v2/config.json. Z.ai-Anmeldung und andere Provider bleiben unverändert. ZCode nach Änderungen neu starten.",
  "integrations.semantics.prime": "Verwaltet nur providers.nexcode in der models.json von Prime Agent — ~/.prime/agent, sofern PRIME_AGENT_CODING_AGENT_DIR sie nicht umleitet. Andere Provider und Modell-Overrides bleiben unverändert. Gilt für neue Sitzungen.",
  ...
  "codexAuth.switchDesc": "Nach der Bestätigung beendet NexCode laufende Codex-Prozesse und wechselt die native Anmeldung für Codex CLI und Codex App.",
  "codexAuth.cacheWarning": "Beim Wechsel werden laufende Codex-App- und CLI-Prozesse beendet und anschließend die native Codex-Anmeldung ersetzt. Speichern Sie zuerst Ihre Arbeit.",
  "codexAuth.setAsNext": "Zu diesem Konto wechseln",
  "codexAuth.cancel": "Abbrechen",
  "codexAuth.switchBack": "Zurück zum Hauptkonto?",
  "codexAuth.switchBackDesc": "Nach der Bestätigung beendet NexCode laufende Codex-Prozesse und stellt die zuvor gespeicherte native Codex-Anmeldung wieder her.",
  ...
  "codexAuth.catalogRefreshPending": "Die Änderung wurde gespeichert, aber die Aktualisierung des Codex-Modellkatalogs steht noch aus. Führe nxc sync aus, um es erneut zu versuchen.",
  ...
  "accountPool.strategyDesc": "Wie NexCode einer neuen/ungebundenen Aufgabe ein Konto zuweist.",
  ...
  "api.subtitle": "Mit generierten API-Schlüsseln greifen externe Apps auf den nexcode-Proxy zu. Die Authentifizierung läuft über den {authHeader}-Header; welche Header ein Endpunkt akzeptiert, steht in der Tabelle unten.",
  ...
  "api.authLoopback": "Loopback-Binds (127.0.0.1 oder ::1) umgehen die Authentifizierung. Remote-Binds benötigen einen generierten nxc_-Schlüssel oder NEXCODE_API_AUTH_TOKEN.",
  ...
  "claude.injectAgentsDesc": "Registriert die im Subagenten-Tab gewählten Modelle (plus das aktuelle Standardmodell) als aufrufbare Claude-Code-Agenten (nxc-*). Gilt ab der nächsten Sitzung.",
  ...
  "claude.smallFastModelNativeWarning": "Wenn kein Modell gewählt ist, setzt NexCode keine Hilfsmodell-Overrides. Claude Code kann dann sein natives Sonnet-Modell verwenden, wodurch Kosten bei deinem nativen Anbieter entstehen können.",
  ...
  "storage.policy.schedule.startup": "Beim Start des Verwaltungsdienstes",
  ...
  "modal.invalidPreset": "Diese integrierte Anbietervorlage ist unvollständig. Starten Sie den Verwaltungsdienst neu und versuchen Sie es erneut.",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.copyDoctor": "nxc doctor kopieren",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.howBody": "Fordern Sie in Codex den öffentlichen Modellnamen der Combo an. Ohne eigenen Namen gilt combo/<id>. NexCode wählt ein Ziel und springt nur bei wiederholbaren Upstream-Fehlern. Ist kein Ziel verfügbar, schlägt die Anfrage geschlossen fehl, statt den globalen Standardanbieter zu verwenden.",
  ...
  "grok.subtitle": "Modelle, die nexcode in deiner Grok-Konfiguration registriert hat.",
  ...
  "grok.notConfiguredHint": "Starte den Verwaltungsdienst mit installiertem Grok neu; NexCode schreibt dann einen verwalteten Block nach:",
