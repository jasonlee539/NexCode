...
import { desktopKo } from "./desktop-translations";
...
export const ko: Record<TKey, string> = {
  ...
  "common.retry": "재시도",
  "auth.adminTokenTitle": "NexCode 관리자 토큰 (NEXCODE_ADMIN_AUTH_TOKEN)",
  ...
  // startup health
  "startup.title": "관리 서비스",
  "startup.subtitle": "NexCode 로컬 화면과 계정 관리 도구의 시작 방식을 관리합니다. Codex 모델 요청은 항상 직접 연결됩니다.",
  ...
  "startup.summary.native": "Codex 요청은 직접 연결을 유지합니다",
  "startup.summary.protected": "재부팅 후 NexCode 관리 기능을 사용할 수 있습니다",
  "startup.summary.atRisk": "재부팅 후 NexCode 관리 기능을 사용할 수 없을 수 있습니다",
  "startup.riskDetail": "NexCode 관리 서비스에 영구 시작 방식이 설정되지 않았습니다.",
  "startup.riskDetailCustomLocal": "Codex가 사용자 지정 로컬 게이트웨이를 바라봅니다. nexcode는 해당 게이트웨이의 재시작 수명주기를 관리하거나 검증할 수 없습니다.",
  "startup.riskDetailWindowsShim": "Launcher shim은 지원되는 CLI 스크립트만 보호하며 Windows의 Codex Desktop과 직접 codex.exe 실행은 이를 우회할 수 있습니다.",
  "startup.safeDetail": "관리 서비스 시작 방식이 설정되었습니다. Codex 요청 경로에는 영향을 주지 않습니다.",
  "startup.routing": "Codex 연결 방식",
  "startup.routing.proxy": "이전 로컬 프록시",
  ...
  "startup.restartProtection": "서비스 복구",
  ...
  "startup.serviceHint": "로그인할 때 시작하고 관리 서비스가 중단되면 다시 실행합니다.",
  "startup.installed": "설치됨",
  "startup.notInstalled": "설치되지 않음",
  "startup.unsupported": "지원되지 않음",
  "startup.shim": "Codex launcher shim",
  "startup.shimHint": "지원되는 Codex 스크립트 런처가 시작될 때 nxc ensure를 실행합니다.",
  "startup.healthy": "정상",
  ...
  "startup.tray.hint": "로그인할 때 트레이 아이콘을 띄우고 관리 서비스 시작·중지·재시작·대시보드·상태를 제어합니다.",
  ...
  "startup.tray.error": "Windows 트레이 작업에 실패했습니다. nxc tray status에서 상세 내용을 확인하세요.",
  ...
  "startup.codexRuntime.clampHidden": "NexCode가 Codex {version}을(를) 사용해 일부 reasoning effort 옵션이 숨겨졌습니다.",
  "startup.codexRuntime.clampHiddenWithEfforts": "NexCode가 Codex {version}을(를) 사용해 일부 reasoning effort 옵션이 숨겨졌습니다(제거됨: {efforts}).",
  "startup.codexRuntime.olderBinary": "NexCode가 더 오래된 Codex 바이너리({version})를 사용 중입니다. 더 새 설치를 사용할 수 있습니다.",

  // dashboard
  "dash.subtitle": "Codex 계정, 모델 설정, 로컬 연동을 관리합니다. 모델 요청은 NexCode를 거치지 않습니다.",
  ...
  "dash.mem.reconnecting": "관리 서비스 재시작 중… 다시 연결하는 중",
  "dash.mem.restartFailed": "관리 서비스 재시작에 실패했습니다. 서비스가 실행 중인지 확인하세요.",
  "dash.mem.restartNoSupervisor": "서비스 복구가 없습니다. 관리 서비스를 수동으로 시작해야 할 수 있습니다.",
  ...
  "dash.cannotConnect": "NexCode 관리 서비스에 연결할 수 없습니다. 실행 중인가요?",
  "dash.runStart": "{cmd} 를 실행해 관리 서비스를 시작하세요.",
  "dash.stop": "관리 서비스 중지",
  "dash.stopConfirm": "NexCode 관리 서비스를 중지할까요? Codex 요청은 계속 직접 연결됩니다.",
  "dash.stopFailed": "관리 서비스를 중지하지 못했습니다 (HTTP {status}).",
  "dash.maSwitchFailed": "모드 전환에 실패했습니다 (HTTP {status}).",
  "dash.maNetworkError": "네트워크 오류 — 관리 서비스가 실행 중인지 확인하세요.",
  "dash.stopping": "중지 중…",
  "dash.actions": "관리 서비스",
  ...
  "dash.codexAutoStart": "Codex 실행 시 nexcode 시작",
  "dash.codexAutoStartHint": "설치된 launcher shim이 nxc ensure를 실행하도록 허용합니다. 이 설정은 재부팅 보호를 설치하지 않으므로 시작 안전성에서 실제 상태를 확인하세요.",
  ...
  "dash.shadowCallTooltip": "Codex 앱은 스레드 제목 자동 생성, 커밋 메시지 생성, 스킬 오케스트레이션 같은 내부 작업을 백그라운드로 호출합니다. 이때 쓰는 모델은 클라이언트 버전마다 달라서 nexcode는 {models}를 모두 가로챕니다. 이 설정을 켜면 해당 호출이 선택한 모델로 넘어갑니다.",
  ...
  "dash.maintenanceHint": "Codex 모델 카탈로그를 새로고침하거나 최신 nexcode 릴리스를 설치합니다.",
  ...
  "dash.projectConfigTitle": "프로젝트 Codex 설정이 NexCode를 우회합니다",
  "dash.projectConfigHint": "저장소 로컬 설정이 NexCode 프록시를 덮어씁니다(예: OpenCode Go로 직접 라우팅). 해당 프로젝트에서 ~/.codex/config.toml 프록시를 쓰려면 제거하세요.",
  "dash.checkUpdate": "업데이트 확인",
  "dash.updateTitle": "nexcode 업데이트",
  "dash.updateDesc": "선택한 채널의 npm 최신 버전을 확인한 뒤, 설치 후 관리 서비스를 재시작할지 선택합니다.",
  ...
  "dash.updateRestartHint": "권장. 관리 서비스를 재시작하기 전까지 현재 GUI는 이전 코드로 계속 실행됩니다.",
  "dash.runUpdate": "업데이트",
  "dash.updateReconnecting": "재시작된 관리 서비스를 기다리는 중…",
  "dash.updateStatus.running": "nexcode 업데이트 중입니다.",
  "dash.updateStatus.restarting": "업데이트 설치 완료. 관리 서비스를 재시작하는 중입니다.",
  ...
  // providers
  "prov.subtitle": "nexcode가 Codex로 라우팅하는 업스트림 프로바이더를 설정합니다. 계정으로 로그인하거나, 프로바이더를 추가하거나, 원본 설정을 편집하세요.",
  "prov.add": "프로바이더 추가",
  ...
  "prov.saved": "저장됨! 적용하려면 관리 서비스를 재시작하세요.",
  ...
  "oauthTos.anthropicBody": "Claude 구독 OAuth 토큰을 NexCode 같은 타사 프록시에서 직접 재사용하는 방식은 Anthropic이 지원하는 통합이 아니며 접근이 제한될 수 있습니다. Claude 구독을 사용하는 공식 Agent SDK 통합은 별도입니다.",
  "oauthTos.highBody": "NexCode는 {provider}를 타사 OAuth 경로로 연결합니다. 지원되지 않는 사용 방식이면 접근이 제한되거나 정지될 수 있습니다.",
  "oauthTos.elevatedBody": "NexCode는 {provider}를 비공식 OAuth 경로로 연결합니다. 가능하면 공식 클라이언트를 사용하세요. 비정상적이거나 자동화된 트래픽은 남용으로 간주되어 접근이 제한되거나 정지될 수 있습니다.",
  "oauthTos.saferPath": "더 안전한 방법: NexCode에 API 키를 대신 설정하세요.",
  ...
  "prov.networkError": "네트워크 오류입니다. 관리 서비스가 실행 중인지 확인한 후 다시 시도하세요.",
  ...
  "models.subtitle": "Codex가 보는 모델을 켜고 끕니다 — 네이티브 GPT passthrough와 라우팅된 모델을 프로바이더별로 묶어 보여줍니다(헤더를 클릭하면 접힘). 숨긴 모델은 카탈로그와 선택기에서 빠지지만 정확한 id로 직접 호출할 수 있습니다. 변경 사항은 다음 Codex 턴에 적용됩니다 — nexcode가 Codex의 5분 모델 캐시를 무효화하므로 재시작이 필요 없습니다.",
  ...
  "models.networkError": "네트워크 오류 — 관리 서비스가 실행 중인가요?",
  "models.loadFail": "모델을 불러오지 못했습니다 — 관리 서비스가 실행 중인가요?",
  ...
  // subagents
  "sub.subtitle": "Codex의 {cmd} 는 우선순위 상위 5개 모델만 오버라이드로 노출합니다. 여기서 최대 5개를 선택하면 — 네이티브 gpt 또는 라우팅된 모델 — nexcode가 카탈로그 우선순위를 설정해 정확히 이들이 앞에 옵니다. 다른 모델도 정확한 이름으로 호출할 수 있으며, 이 설정은 표시 항목만 제어합니다.",
  "sub.featured": "추천",
  ...
  "sub.networkError": "네트워크 오류 — 관리 서비스가 실행 중인가요?",
  "sub.loadFail": "모델을 불러오지 못했습니다 — 관리 서비스가 실행 중인가요?",
  "sub.loading": "불러오는 중…",
  "sub.moveUp": "{m} 위로 이동",
  ...
  "logs.tabLogs": "로그",
  "logs.tabDebug": "디버그",
  "logs.subtitle": "로컬 nexcode 프록시를 거친 최근 요청입니다. 최신순.",
  ...
  "modal.networkError": "네트워크 오류 — 관리 서비스가 실행 중인가요?",
  ...
  "nav.openMenu": "메뉴 열기",
  "nav.closeMenu": "메뉴 닫기",
  "integrations.subtitle": "클라이언트를 nexcode에 연결하고 자격 증명과 설정 복원을 관리합니다.",
  ...
  "integrations.codex.body": "Codex 연결은 프록시 서비스가 관리합니다. nexcode를 시작하면 적용되고 서비스를 중지하면 기본 라우팅으로 복원됩니다.",
  ...
  "integrations.dialog.desktop.changes": "{path}에 nexcode 게이트웨이 프로필이 있으면 먼저 자격 증명 없는 표준 프로필을 선택한 뒤 이전 프로필과 백업을 제거합니다.",
  "integrations.dialog.desktop.breakage": "Claude Desktop은 nexcode를 통한 모델 대신 표준 Claude로 돌아갑니다.",
  "integrations.dialog.desktop.undo": "다시 켜면 저장된 모델 할당으로 nexcode 프로필을 새로 만듭니다.",
  ...
  "integrations.native.error.desktopCleanupIncomplete": "Claude Desktop은 표준 모드를 가리키지만 이전 nexcode 자격 증명 파일이 남아 있습니다: {paths}.",
  ...
  "integrations.detail.grokAbsent": "설정에 nexcode 블록이 없습니다",
  "integrations.dialog.grok.title": "Grok Build 연동을 해제할까요?",
  "integrations.dialog.grok.changes": "{path}에서 nexcode가 표시해 둔 블록만 제거합니다. 블록 바깥에 직접 쓴 내용은 그대로 둡니다.",
  "integrations.dialog.grok.breakage": "해제하면 Grok Build에서 nexcode 모델 별칭이 사라집니다. xAI 계정으로 쓰던 모델은 그대로입니다.",
  "integrations.dialog.grok.undo": "nexcode가 loopback 주소로 실행 중이면, 다시 켤 때 지금 쓸 수 있는 모델 목록으로 블록을 새로 씁니다.",
  "integrations.dialog.grok.confirm": "해제",
  "integrations.native.msg.nonLoopbackRemoved": "Grok Build은 nexcode가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. loopback 주소를 가리키던 이전 블록은 제거했습니다.",
  "integrations.native.msg.nonLoopbackRemovedNoop": "Grok Build은 nexcode가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. 제거할 이전 블록은 없었습니다.",
  "integrations.native.msg.nonLoopbackSuperseded": "Grok Build은 nexcode가 loopback 주소로 실행 중일 때만 자동 등록할 수 있습니다. 그 사이 다른 곳에서 설정에 블록이 새로 쓰여, 지금 파일에 있는 블록은 이 요청이 만든 것이 아닙니다.",
  "integrations.native.error.orphanedMarker": "{path}에 nexcode 시작 표시는 있는데 끝 표시가 없습니다. 어디까지가 우리 블록인지 확신할 수 없어 파일을 건드리지 않았습니다.",
  ...
  "integrations.onboarding": "적용하면 먼저 백업을 보관한 뒤 nexcode 제공자 블록 하나만 씁니다. 해제는 그 블록만 제거하며 보관된 스냅샷으로 복원할 수 있습니다.",
  "integrations.empty.title": "설치된 클라이언트가 감지되지 않았습니다",
  "integrations.empty.body": "지원 클라이언트를 설치한 뒤 돌아와 nexcode를 적용하세요.",
  ...
  "integrations.error.conflict": "nexcode가 쓴 뒤 설정이 변경되었습니다. 아무 내용도 제거하지 않았습니다.",
  ...
  "integrations.bulk.body": "nexcode가 소유한 블록만 제거합니다. 각 클라이언트의 변경 전 스냅샷을 보관합니다.",
  ...
  "integrations.semantics.opencode": "디스크에서 직접 실행할 때만 적용됩니다. nxc opencode의 환경 주입이 우선합니다.",
  ...
  "integrations.semantics.dsh": "NexCode는 $DSH_HOME/settings.yaml의 llm-pi-ai.providers.nexcode만 관리합니다. DSH는 이 provider를 hot reload하며 기본 model과 deepseek-official은 변경하지 않습니다. 현재 loopback 전용이며 실제 credential을 기록하지 않습니다.",
  "integrations.semantics.mcode": "custom_provider.nexcode만 관리하며 기본 모델과 MiniMax 로그인은 변경하지 않습니다.",
  "integrations.semantics.zcode": "~/.zcode/v2/config.json의 provider.nexcode만 관리하며 Z.ai 로그인과 다른 프로바이더는 변경하지 않습니다. 변경 후 ZCode를 재시작하세요.",
  "integrations.semantics.prime": "Prime Agent의 models.json에서 providers.nexcode만 관리합니다. 위치는 ~/.prime/agent이며 PRIME_AGENT_CODING_AGENT_DIR가 설정되면 그쪽이 우선합니다. 다른 프로바이더와 모델 오버라이드는 변경하지 않습니다. 새 세션부터 적용됩니다.",
  ...
  "codexAuth.switchDesc": "확인하면 실행 중인 Codex 프로세스를 종료하고 Codex CLI와 Codex App이 공유하는 기본 로그인을 전환합니다.",
  "codexAuth.cacheWarning": "전환하면 실행 중인 Codex 앱과 CLI 프로세스를 종료한 뒤 Codex 기본 로그인을 교체합니다. 먼저 작업을 저장하세요.",
  "codexAuth.setAsNext": "이 계정으로 전환",
  "codexAuth.cancel": "취소",
  "codexAuth.switchBack": "메인 계정으로 돌아가시겠습니까?",
  "codexAuth.switchBackDesc": "확인하면 실행 중인 Codex 프로세스를 종료하고 계정 관리 전에 저장한 Codex 기본 로그인을 복원합니다.",
  ...
  "codexAuth.catalogRefreshPending": "변경 사항은 저장되었지만 Codex 모델 카탈로그 새로 고침이 보류 중입니다. nxc sync를 실행해 다시 시도하세요.",
  ...
  "accountPool.strategyDesc": "NexCode가 새 작업/바인딩 없는 작업에 계정을 배정하는 방식입니다.",
  ...
  // api access page
  "api.title": "API 액세스",
  "api.subtitle": "생성한 API 키로 외부 앱에서 nexcode 프록시에 접속합니다. 인증은 {authHeader} 헤더로 하며, 엔드포인트별로 받는 헤더는 아래 표에 있습니다.",
  ...
  "api.authTitle": "인증",
  "api.authLoopback": "루프백 바인드(127.0.0.1 또는 ::1)는 인증을 건너뜁니다. 원격 바인드는 생성된 nxc_ 키 또는 NEXCODE_API_AUTH_TOKEN이 필요합니다.",
  ...
  "claude.authModeHint": "subscription은 Claude 계정 필요, proxy는 nexcode 프록시만으로 사용 가능",
  ...
  "claude.injectAgentsDesc": "위 '서브에이전트' 탭에서 고른 모델들(+현재 기본 모델)을 Claude Code의 파견 가능한 에이전트(nxc-*)로 자동 등록합니다. 새 세션부터 적용돼요.",
  ...
  "claude.smallFastModelNativeWarning": "비워 두면 NexCode가 보조 모델 환경 변수를 설정하지 않습니다. Claude Code가 네이티브 Sonnet 모델을 사용할 수 있으며, 네이티브 프로바이더 요금이 발생할 수 있습니다.",
  ...
  "storage.policy.schedule.startup": "관리 서비스 시작 시",
  ...
  "modal.badge.pool": "풀",
  "modal.badge.free": "무료",
  "modal.invalidPreset": "내장 프로바이더 설정이 완전하지 않습니다. 관리 서비스를 다시 시작한 뒤 재시도하세요.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.howTitle": "동작 방식",
  "cws.howBody": "Codex에서 콤보의 공개 모델 이름을 요청하세요. 설정하지 않으면 combo/<id>가 기본값입니다. NexCode는 재시도 가능한 업스트림 오류에서만 다음 대상으로 넘깁니다. 사용 가능한 대상이 없으면 전역 기본 프로바이더로 우회하지 않고 요청을 실패 처리합니다.",
  ...
  "grok.subtitle": "nexcode가 Grok 설정에 등록한 모델입니다.",
  "grok.loading": "Grok 상태를 불러오는 중…",
  "grok.loadFail": "Grok 설정을 읽지 못했습니다.",
  "grok.notConfiguredTitle": "Grok Build가 연결되지 않았습니다",
  "grok.notConfiguredHint": "Grok을 설치한 뒤 관리 서비스를 다시 시작하면 NexCode가 관리 블록을 다음 위치에 씁니다:",
  "grok.endpoint": "엔드포인트",
  "grok.colModel": "모델",
