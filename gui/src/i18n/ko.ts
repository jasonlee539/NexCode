...
export const ko: Record<TKey, string> = {
  ...
  "startup.subtitle": "재부팅 후 로컬 프록시 라우팅이 재연결 반복으로 이어지기 전에 Codex가 nexcode에 연결될 수 있는지 확인합니다.",
  ...
  "startup.summary.protected": "재부팅 후에도 nexcode가 자동으로 준비됩니다",
  ...
  "startup.safeDetail": "현재 라우팅과 시작 방식이 일치합니다. 재부팅 후 nxc start를 수동으로 실행할 필요가 없습니다.",
  ...
  // dashboard
  "dash.subtitle": "로컬 nexcode 프록시와 프로바이더, 그리고 Codex로 라우팅되는 모델의 실시간 상태입니다.",
  ...
  "codexAuth.nativeSwitchDesc": "NexCode가 실행 중인 Codex 프로세스를 종료하고 네이티브 Codex 로그인을 교체합니다. 모델 요청은 계속 OpenAI에 직접 연결됩니다. 전환 후 Codex를 다시 여세요.",
  "codexAuth.cacheWarning": "계정 전환 시 프롬프트 캐시가 초기화됩니다.",
  "codexAuth.setAsNext": "이 계정을 다음에 사용",
  "codexAuth.nativeSwitchAction": "네이티브 로그인 전환",
  "codexAuth.cancel": "취소",
  ...
  "codexAuth.nativeSwitched": "{email}이(가) 이제 네이티브 Codex 로그인입니다. Codex를 다시 여세요.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "grok.notConfiguredHint": "Grok을 설치한 뒤 프록시를 다시 시작하면 nexcode가 관리 블록을 다음 위치에 씁니다:",
  "grok.endpoint": "엔드포인트",
  "grok.colModel": "모델",
