...
export function ClaudeCodeQuickstartSection({ manualEnv }: { manualEnv: string }) {
  ...
  return (
    <>
      <p className="muted text-label" style={{ margin: "0 0 8px" }}><Trans k="claude.quickstartHint" cmd="nxc claude" /></p>
      <pre className="mono card" style={{ padding: "10px 14px", overflowX: "auto", margin: 0 }}>nxc claude</pre>
