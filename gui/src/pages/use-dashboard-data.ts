...
const CONTROLS_CACHE_PREFIX = "nxc.dash.controls.v1:";
const OVERVIEW_CACHE_PREFIX = "nxc.dash.overview.v1:";
const USAGE_CACHE_PREFIX = "nxc.dash.usage30d.v1:";
const STARTUP_CACHE_PREFIX = "nxc.dash.startup.v1:";
const MA_MODE_CACHE_PREFIX = "nxc.dash.maMode.v1:";
