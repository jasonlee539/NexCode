...
**Tech Stack:** TypeScript, Bun tests, Node `crypto` Ed25519, existing Lab JSONL/SQLite/query/digest/path infrastructure, existing `nxc lab` CLI and authenticated management API, existing Compatibility Matrix UI/i18n.
