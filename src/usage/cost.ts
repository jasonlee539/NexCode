...
/**
 * Normalize inclusive NxcUsage (types.ts: inputTokens INCLUDES cache read/write)
 ...
 */
export function normalizeCostTokens(usage: NxcUsage): CostTokens | null {
...
function isEstimated(usage: NxcUsage, usageStatus: UsageStatus, priceStatus: ExpectedPriceStatus | "verified"): boolean {
