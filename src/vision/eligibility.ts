 ...
 *    explicit modalities.
 */
import { modelInList, type NxcConfig, type NxcProviderConfig } from "../types";
...
type EnrichedProviderCache = Map<string, NxcProviderConfig>;
 ...
 */
export function isVisionSidecarConsumer(config: Pick<NxcConfig, "providers">, providerName: string, modelId: string): boolean {
