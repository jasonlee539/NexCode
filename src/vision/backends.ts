...
export interface VisionBackendDescriptor {
  ...
  isActive(auth: SidecarAuthState, config: NxcConfig): boolean;
 ...
 */
export function activeVisionBackends(auth: SidecarAuthState, config: NxcConfig): VisionSidecarBackend[] {
