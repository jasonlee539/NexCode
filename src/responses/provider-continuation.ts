...
export function isValidProviderContinuationOwner(
  value: unknown,
): value is NxcProviderContinuationOwner {
  if (!value || typeof value !== "object" || Array.isArray(value)) return false;
...
export function providerContinuationOwnerFromReplayIdentity(
  identity: Readonly<NxcReasoningReplayIdentity> | undefined,
): NxcProviderContinuationOwner | undefined {
  if (!identity) return undefined;
  const owner: NxcProviderContinuationOwner = {
    version: 1,
...
export function sameProviderContinuationOwner(
  left: NxcProviderContinuationOwner,
  right: NxcProviderContinuationOwner,
): boolean {
...
export function providerContinuationRouteScope(owner: NxcProviderContinuationOwner): string {
