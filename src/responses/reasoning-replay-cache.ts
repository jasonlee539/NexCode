...
function keyFor(callId: string, scope: NxcReasoningReplayScopeRef | undefined): string | undefined {
...
export function reasoningReplayKeyCredentialIdentity(
  provider: Pick<NxcProviderConfig, "apiKey" | "headers">,
): string | undefined {
...
export function bindReasoningReplayScope(
  scope: NxcReasoningReplayScopeRef | undefined,
  identity: NxcReasoningReplayIdentity | undefined,
): void {
  if (!scope) return;
...
export function rememberReasoningForCall(
  callId: string,
  text: string,
  scope?: NxcReasoningReplayScopeRef,
): void {
