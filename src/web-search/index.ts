import type { NxcConfig, NxcParsedRequest, NxcProviderConfig } from "../types";
...
import type { NxcWebSearchSidecarConfig } from "../types";
 ...
 */
export function findAnthropicSidecarProvider(config: NxcConfig): AnthropicSidecarProvider | undefined {
 ...
 */
export function findXaiSidecarProvider(config: NxcConfig): { providerName: string; provider: NxcProviderConfig } | undefined {
 ...
 */
export function findGeminiSidecarProvider(config: NxcConfig): { providerName: string; provider: NxcProviderConfig } | undefined {
...
export function xaiSearchOptionsFromConfig(cfg: Pick<NxcWebSearchSidecarConfig, "xSearch">): XaiSearchOptions {
  const x = cfg.xSearch;
