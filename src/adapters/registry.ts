...
export const ADAPTER_REGISTRY = {
  "command-code": {
    ...
    create: (provider: NxcProviderConfig, _context: AdapterFactoryContext) => createCommandCodeAdapter(provider),
  },
  "openai-chat": {
    wire: "openai-chat",
    mutation: "codex-owned",
    create: (provider: NxcProviderConfig, _context: AdapterFactoryContext) =>
      withClinePassDeepSeekV4ToolReplayCompatibility(createOpenAIChatAdapter(provider)),
  },
  anthropic: {
    wire: "anthropic",
    mutation: "codex-owned",
    create: (provider: NxcProviderConfig, context: AdapterFactoryContext) =>
  ...
  google: {
    wire: "google",
    mutation: "codex-owned",
    create: (provider: NxcProviderConfig, _context: AdapterFactoryContext) => createGoogleAdapter(provider),
  },
  kiro: {
    wire: "kiro",
    mutation: "codex-owned",
    create: (provider: NxcProviderConfig, _context: AdapterFactoryContext) => createKiroAdapter(provider),
  },
  azure: {
    contractParent: "openai-responses",
    create: (provider: NxcProviderConfig, _context: AdapterFactoryContext) => createAzureAdapter(provider),
  },
  "azure-openai": {
    contractParent: "openai-responses",
    create: (provider: NxcProviderConfig, _context: AdapterFactoryContext) => createAzureAdapter(provider),
  ...
  cursor: {
    ...
    create: (provider: NxcProviderConfig, _context: AdapterFactoryContext) => createCursorAdapter(provider),
  },
  "mimo-free": {
    contractParent: "openai-chat",
    create: (provider: NxcProviderConfig, _context: AdapterFactoryContext) => createMimoFreeAdapter(provider),
  },
