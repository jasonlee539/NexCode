...
export type ParsedKiroEvent =
  ...
  | { type: "metadata"; usage?: NxcUsage; contextUsagePercentage?: number; stopReason?: string }
...
function parseTokenUsage(eventType: string, value: unknown): NxcUsage | undefined {
  if (value === undefined || value === null) return undefined;
