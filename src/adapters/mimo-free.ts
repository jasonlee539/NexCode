...
import type { NxcProviderConfig, NxcParsedRequest } from "../types";
 ...
 * persisted under the config dir (NEXCODE_HOME-aware) — deliberately NOT derived
 ...
 */
export function createMimoFreeAdapter(provider: NxcProviderConfig): ProviderAdapter {
  ...
  return {
    ...
    async buildRequest(parsed: NxcParsedRequest, incoming: IncomingMeta): Promise<AdapterRequest> {
