...
import type { NxcParsedRequest, NxcProviderConfig } from "../types";
import { createResponsesPassthroughAdapter } from "./openai-responses";

export function createAzureAdapter(provider: NxcProviderConfig): ProviderAdapter & { passthrough: true } {
