 ...
 * advertised "...served through / running via the nexcode proxy", which leaked our proxy identity
...
/** Proxy-neutral replacement: no "nexcode proxy" mention, just the GPT-5/OpenAI disclaimer. */
