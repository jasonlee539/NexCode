import type { NxcParsedRequest, NxcTool } from "../types";
...
function omittedToolCatalogNotice(kept: number, omitted: readonly NxcTool[], registry: KiroToolNameRegistry): string {
  ...
  return `[nexcode] Kiro's outbound catalog budget allows ${kept} of ${kept + omitted.length} client tools this turn. Omitted and unavailable this turn: ${summary}.`;
}
...
export function convertKiroTools(parsed: NxcParsedRequest): unknown[] {
