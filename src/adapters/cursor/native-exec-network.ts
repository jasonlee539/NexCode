...
const NATIVE_FETCH_DISABLED =
  "Cursor-native fetch is not executed locally. Use the Codex shell bridge tool `shell_command` (aliases: `exec_command`, `mcp_nexcode-responses_shell_command`, `mcp_nexcode-responses_exec_command`) with curl or wget.";
