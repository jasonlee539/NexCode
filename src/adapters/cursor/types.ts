...
import type { NxcMessage, NxcRequestOptions, NxcTool } from "../../types";
...
export interface CursorRunRequest {
  ...
  rawMessages?: readonly NxcMessage[];
  /**
...
export type CursorServerMessage =
  ...
  | { type: "done"; usage?: NxcUsage }
  | { type: "error"; message: string; usage?: NxcUsage }
  | { type: "heartbeat" }
