 ...
 * fail-closed: nexcode has no trustworthy per-request attestation that caller-supplied
 * Responses instructions/system/developer prose reflects a real Codex sandbox state.
 */
export function resolveCursorNativeExecMode(provider: NxcProviderConfig): CursorNativeExecMode {
...
export function effectiveCursorNativeExecAllow(provider: NxcProviderConfig, requestDeclaresFullAccess: boolean): boolean {
