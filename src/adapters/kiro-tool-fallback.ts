import type { NxcContentPart, NxcToolCall, NxcToolResultMessage } from "../types";
...
function contentText(content: string | NxcContentPart[]): string {
...
export function toolCallFallbackText(toolCall: NxcToolCall): string {
  return [
...
export function toolResultFallbackText(toolResult: NxcToolResultMessage): string {
  return [
