...
function conservativeFallback(config: Pick<NxcConfig, "codexAutoStart">): StartupHealth {
...
function runProbe(config: Pick<NxcConfig, "codexAutoStart">): Promise<StartupHealth> {
...
function refreshInBackground(config: Pick<NxcConfig, "codexAutoStart">): void {
  if (inflight) return;
...
export async function getCachedStartupHealth(config: Pick<NxcConfig, "codexAutoStart">): Promise<StartupHealth> {
