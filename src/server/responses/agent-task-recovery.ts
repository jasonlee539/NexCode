...
export function agentTaskRecoveryConfig(config: NxcConfig): AgentTaskRecoveryOptions | null {
...
function recoveryAdmission(req: Request, config: NxcConfig): RecoveryAdmission | null {
  ...
  if (req.headers.has("x-nexcode-api-key") || req.headers.has("x-api-key")) return null;
