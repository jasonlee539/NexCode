 ...
 */
export async function fetchAllModels(config: NxcConfig): Promise<CatalogModel[]> {
 ...
 */
export async function fetchGrokCandidateModels(config: NxcConfig): Promise<GrokCandidateModel[]> {
...
export function stripRegistryOnlyStaticHeaders(name: string, provider: NxcProviderConfig): NxcProviderConfig {
...
export async function buildClaudeDesktopState(config: NxcConfig, stored?: NxcClaudeDesktopProfile) {
