 ...
 *   reset cannot recover serving. Clear inherited `NXC_SERVICE` so exit cleanup
...
function isSupervisedServiceChild(io: SystemRestartIo = {}): boolean {
  if (process.env.NXC_SERVICE !== "1") return false;
