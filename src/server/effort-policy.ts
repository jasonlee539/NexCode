...
export function effortCapFor(config: NxcConfig, subagent: boolean): string | undefined {
  const caps: string[] = [];
...
export function supportedLadderFor(route: { provider: NxcProviderConfig; modelId: string }): string[] | undefined {
