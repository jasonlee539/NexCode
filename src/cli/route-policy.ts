...
const USAGE = `Usage:
  nxc route policy list [--json]
  nxc route policy show <id> [--json]
  nxc route policy dry-run <id> [--model-context <tokens>] [--tools]
      [--image] [--structured-output] [--json]
  nxc route policy evaluate <id> [--model-context <tokens>] [--tools]
      [--image] [--structured-output] [--json]`;
