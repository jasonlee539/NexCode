/**
 * `nxc lab` — Compatibility Lab inspection and explicit CL-08 automation controls.
 *
...
const USAGE = `Usage:
  nxc lab status [--json]
  nxc lab production-signals --subject <id> [--limit <n>] [--json]
  nxc lab verdicts [--subject <id>] [--layer <layer>] [--suite <id>] [--verdict <v>] [--from <ms>] [--to <ms>] [--limit <n>] [--cursor <c>] [--json]
  nxc lab subjects [--kind <kind>] [--limit <n>] [--cursor <c>] [--json]
  nxc lab subject <subjectId> [--json]
  nxc lab observations [--subject <id>] [--layer <layer>] [--suite <id>] [--scenario <id>] [--outcome <o>] [--execution-mode <m>] [--from <ms>] [--to <ms>] [--limit <n>] [--cursor <c>] [--json]
  nxc lab events [--event-kind <k>] [--subject <id>] [--from <ms>] [--to <ms>] [--excluded <true|false>] [--limit <n>] [--cursor <c>] [--json]
  nxc lab event <eventId> [--json]
  nxc lab artifacts [--status <s>] [--artifact-class <c>] [--limit <n>] [--cursor <c>] [--json]
  nxc lab artifact <digest> [--json]
  nxc lab catalog [--layer <layer>] [--suite <id>] [--json]
  nxc lab public preview --event <eventId> [--event <eventId> ...] [--json]
  nxc lab public export --event <eventId> [--event <eventId> ...] [--json]
  nxc lab public verify --file <bundle.json> [--json]
  nxc lab public import --file <bundle.json> [--json]
  nxc lab public community [--json]
  nxc lab automation status [--json]
  nxc lab automation enable [--protocol] [--live] [--json]
  nxc lab automation disable [--json]
  nxc lab automation runs [--limit <n>] [--cursor <c>] [--json]
  nxc lab run --layer <layer> --scenario <id> [--provider <name>] [--model <id>] [--json]`;
