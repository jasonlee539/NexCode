...
const USAGE = `Usage:
  nxc provider edit <name> [--adapter <id>] [--base-url <url>] [--default-model <id|->]
  ...
  nxc provider test <name> [--json]
  nxc provider quota [--refresh] [--json]
  nxc provider presets [--json]
  nxc provider account-mode <pool|direct> [--json]
  nxc provider selected <name> [--set <model,model...>] [--clear] [--json]`;
