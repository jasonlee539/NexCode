...
const USAGE = `Usage:
  ...
  nxc access key create [name] [--json]
  nxc access key remove <id> --yes [--json]
  nxc access endpoints [--json]
  nxc access models [--json]
  nxc access test <model> [--protocol <chat|responses|messages>] [--json]`;
