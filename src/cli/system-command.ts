...
const USAGE = `Usage:
  nxc system [status] [--json]
  nxc system settings [--auto-start <on|off>] [--stream-mode <auto|legacy-tee|eager-relay>] [--json]
  nxc system startup <health|install-service|install-shim> [--json]
  nxc system diagnostics [--json]
  nxc system sync [--json]
  nxc system update check [--channel <latest|preview>] [--json]
  nxc system update run [--channel <latest|preview>] [--restart <on|off>] --yes [--json]
  nxc system update status <job-id> [--json]`;
