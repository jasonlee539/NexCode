...
const USAGE = `Usage:
  nxc agent [status] [--json]
  nxc agent injection <status|set> [--model <id|->] [--effort <level|->]
      [--prompt <text|->] [--guidance <on|off>] [--json]
  nxc agent effort <status|set> [--main <level|->] [--subagent <level|->] [--json]
  nxc agent subagents <status|set|clear> [model,model...] [--json]
  nxc agent fallback <status|set|clear> [model,model...] [--poll-ms <5000-600000>] [--json]
  nxc agent sidecar <status|web|vision> [--list] [--model <id|->]
