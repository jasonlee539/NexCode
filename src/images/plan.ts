...
export function findXaiProvider(config: NxcConfig): { name: string; provider: NxcProviderConfig } | undefined {
 ...
 */
export function resolveXaiImageApiKey(provider: NxcProviderConfig): string | undefined {
...
export async function planImageBridge(
  ...
  routedProvider: NxcProviderConfig,
