...
/** Honest NexCode client fingerprint; VS Code-shaped values only if API requires them later. */
export const GITHUB_COPILOT_EDITOR_HEADERS: Readonly<Record<string, string>> = {
  "Editor-Version": "nexcode/0.1.0",
  "Editor-Plugin-Version": "nexcode/0.1.0",
