 ...
 * as monitor-only. The lock serializes NexCode against itself; it does not
...
function hasCurrentLogsTable(db: Database, columns: ColumnRow[]): boolean {
  ...
  // Protect intentionally installs NexCode-owned triggers and unrelated user triggers
