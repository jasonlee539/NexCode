...
function comboAliasNamespaces(config: Pick<NxcConfig, "combos">): string[] {
...
function occupiedNamespaces(
  config: Pick<NxcConfig, "combos" | "providers" | "routingProfiles">,
): Set<string> {
  return new Set([
...
export function defaultCodexAccountNamespaces(
  config: Pick<NxcConfig, "codexAccounts" | "combos" | "providers" | "routingProfiles">,
...
export function codexAccountNamespaceEntries(
  config: Pick<NxcConfig, "codexAccountNamespaces">,
): Array<[string, string]> {
...
export function codexAccountPickerEnabled(
  config: Pick<NxcConfig, "codexAccountNamespaces" | "codexAccountPickerEnabled">,
): boolean {
