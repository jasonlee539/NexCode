...
export function isCodexAccountPaused(config: NxcConfig, accountId: string): boolean {
...
export function setCodexAccountPaused(config: NxcConfig, accountId: string, paused: boolean): void {
...
export function forgetCodexAccountPause(config: NxcConfig, accountId: string): void {
