...
export function nexCodeCoordinatorTransaction(finalDatabasePath: string): CodexCoordinatorTransactionController {
...
export const readCodexTransitionState: ReadCodexTransitionState = () => {
  ...
  try {
    transaction = nexCodeCoordinatorTransaction(currentCoordinatorDatabasePath());
