...
function copyMigrationField(target: NxcConfig, source: NxcConfig): void {
...
/** Canonical slugs that may classify old, unmarked NexCode custom rows. */
export function legacyCustomModelCatalogSlugs(config: NxcConfig): ReadonlySet<string> {
