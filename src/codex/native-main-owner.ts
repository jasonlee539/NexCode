...
export const NATIVE_MAIN_OWNER_DB = ".nexcode-native-main.owner.sqlite";
...
export function assertNativeMainOwner(context: NativeProfileContext): void {
  ...
  throw new NativeProfileError(
    ...
    unavailable
      ...
      : "Another NexCode process owns the physical native-main login for the effective CODEX_HOME.",
    503,
    true,
  );
}
