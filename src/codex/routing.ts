...
export function listLiveCodexAccountIds(config: NxcConfig): ReadonlySet<string> {
...
function stickyLimitForConfig(config: NxcConfig): number {
 ...
 */
function hasCodexQuotaHeadroom(config: NxcConfig, accountId: string): boolean {
...
export function getPoolAccountPlan(config: NxcConfig, accountId: string): string | undefined {
...
function pickLowestUsageAmong(config: NxcConfig, ids: readonly string[]): string | null {
...
export function getEffectiveActiveCodexAccountId(config: NxcConfig): string | undefined {
 ...
 */
export function isEffectiveCodexAccountPinned(config: NxcConfig): boolean {
 ...
 */
function rememberActiveCodexAccount(_config: NxcConfig, accountId: string): void {
 ...
 */
function releaseCodexAccountPinFor(config: NxcConfig, accountId: string): boolean {
  const pinned = pinnedCodexAccountId(config);
...
function setActiveCodexAccount(config: NxcConfig, accountId: string): void {
  runtimeActiveCodexAccountId = undefined;
...
function promoteActiveCodexAccount(config: NxcConfig, accountId: string): void {
 ...
 * most once per pin.
 */
function releaseDrainedCodexAccountPin(config: NxcConfig): void {
  const pinned = pinnedCodexAccountId(config);
...
function shouldFailover(config: NxcConfig, accountId: string, now: number): boolean {
...
export function formatCodexProviderForLog(providerName: string, accountId: string | null, config: NxcConfig): string {
