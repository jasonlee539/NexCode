 ...
 */
export function getCodexAccountPriority(config: NxcConfig, accountId: string): number {
 ...
 */
export function setCodexAccountPriority(config: NxcConfig, accountId: string, priority: number): void {
...
export function forgetCodexAccountPriority(config: NxcConfig, accountId: string): void {
 ...
 */
export function codexAccountPriorityLookup(config: NxcConfig): (accountId: string) => number {
 ...
 */
export function pinnedCodexAccountId(config: NxcConfig): string | undefined {
  return config.activeCodexAccountPinned;
}

export function isCodexAccountPinned(config: NxcConfig, accountId: string): boolean {
  return config.activeCodexAccountPinned === accountId;
}

export function setCodexAccountPin(config: NxcConfig, accountId: string): void {
  config.activeCodexAccountPinned = accountId;
}

/** Release the pin. With `accountId` given, only when it is the pinned account. */
export function clearCodexAccountPin(config: NxcConfig, accountId?: string): void {
