...
const VERSION_DOMAIN = "nxc-lab:compatibility-version:v1";
...
/**
 * NexCode compatibility version for route subject identity.
 *
 ...
 */
export function readNexCodeCompatibilityVersion(): string | null {
