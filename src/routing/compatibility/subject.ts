...
import { readNexCodeCompatibilityVersion } from "./version";
...
export function resolveCompatibilitySubjectsForInboundWire(
  ...
  const compatibilityVersion = readNexCodeCompatibilityVersion();
  ...
  const routeContext: LabRouteContext = {
    ...
    surface,
    baseUrl,
    nexcodeCompatibilityVersion: compatibilityVersion,
    behaviorValues,
    dependencies: [],
  };
