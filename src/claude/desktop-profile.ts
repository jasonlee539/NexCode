...
export type DesktopFamily = NxcClaudeDesktopFamily;
export type DesktopProfile = NxcClaudeDesktopProfile;
...
export function parseDesktopProfile(value: unknown): DesktopProfile {
  ...
  const assignments: Record<string, NxcClaudeDesktopAssignment> = {};
