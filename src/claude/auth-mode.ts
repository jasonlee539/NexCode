 ...
 *
 * The resolver answers exactly ONE question: does the nexcode-owned dummy token
 * (`ANTHROPIC_AUTH_TOKEN=nexcode-proxy`) get injected? That is narrower than "how
 ...
 */
export function resolveClaudeAuthMode(config: NxcConfig, detection: AuthDetectResult): ResolvedAuthMode {
...
export function authModeIntent(config: NxcConfig): AuthModeIntent {
