 ...
 * omitted because nexcode has no truthful values for the official fields.
 */
export function resolveProviderTransport(
  providerName: string,
  provider: NxcProviderTransport,
  promptCacheKey?: string,
  apiBaseUrl?: string,
): NxcProviderTransport {
