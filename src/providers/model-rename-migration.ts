 ...
 */
function renameDisabledModels(config: NxcConfig, rename: ModelRename): boolean {
 ...
 */
function providerStillMatchesRegistry(name: string, prov: NxcProviderConfig): boolean {
