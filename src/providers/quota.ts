...
function cacheKey(config: NxcConfig): string {
...
function hasCodexPoolProvider(config: NxcConfig): boolean {
...
function isBuiltInChatGptForwardProvider(name: string, provider: NxcProviderConfig): boolean {
...
async function fetchA6apiQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
...
async function fetchOpenCodeGoQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
 ...
 */
async function fetchOpenRouterQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
  // Never send a configured API key to a lookalike host or through a redirect.
 ...
 */
async function fetchDeepSeekQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
 ...
 */
async function fetchClineQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
 ...
 */
async function fetchZaiQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
 ...
 */
async function fetchMinimaxQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
 ...
 */
async function fetchMoonshotQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
 ...
 */
async function fetchVeniceQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
 ...
 */
async function fetchSyntheticQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
 ...
 */
async function fetchDeepInfraQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
 ...
 */
async function fetchNeuralwattQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
...
async function fetchChatGptForwardQuota(
  config: NxcConfig,
  provider: string,
  providerConfig: NxcProviderConfig,
...
async function resolveKimiQuotaBearer(config: NxcProviderConfig): Promise<string | null> {
...
async function fetchKimiQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaReport | null> {
...
async function resolveCommandCodeQuotaBearer(config: NxcProviderConfig): Promise<string | null> {
  if (config.authMode === "oauth") {
    try {
 ...
 */
async function fetchCommandCodeQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaProbeResult> {
  // Never release credentials to a user-edited or lookalike provider host.
...
async function fetchAntigravityQuota(provider: string, config: NxcProviderConfig): Promise<ProviderQuotaReport | null> {
...
async function maybeFetchProviderQuota(
  ...
  try {
    ...
    // silently had no quota panel and no `nxc provider quota --json` report while the literal
...
export async function fetchProviderQuotaReports(config: NxcConfig, forceRefresh = false): Promise<ProviderQuotaResponse> {
