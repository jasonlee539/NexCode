...
export function listOpenAiForwardSidecarCandidates(config: NxcConfig): OpenAiForwardSidecarCandidate[] {
...
export function selectOpenAiImagesProvider(config: NxcConfig): OpenAiImagesProviderSelection {
...
export function selectImagesProvider(config: NxcConfig): OpenAiImagesProviderSelection {
