import type { NxcProviderConfig, RequestPacingRule } from "../types";
...
export function requestPacingIntervalMs(provider: NxcProviderConfig, modelId?: string): number {
...
function requestPacingIntervals(provider: NxcProviderConfig, modelId?: string): {
  providerIntervalMs: number;
  modelIntervalMs: number;
} {
  const policy = provider.requestPacing;
