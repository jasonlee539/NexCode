...
export function providerSupportsLiveModelDiscovery(name: string, provider: NxcProviderConfig): boolean {
...
export function repairStaticModelCatalogProvider(name: string, provider: NxcProviderConfig): void {
