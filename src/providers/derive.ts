import type { CodexAccountMode, NxcProviderConfig } from "../types";
 ...
 */
export function providerConfigSeed(entry: ProviderRegistryEntry): NxcProviderConfig {
...
export function deriveOAuthProviderConfig(id: string): NxcProviderConfig | undefined {
 ...
 */
function enrichReasoningSummariesByDestination(prov: NxcProviderConfig): void {
...
export function hasLegacyClinePassReasoningEfforts(name: string, prov: NxcProviderConfig): boolean {
...
export function enrichProviderFromRegistry(name: string, prov: NxcProviderConfig): void {
