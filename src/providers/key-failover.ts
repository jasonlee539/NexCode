...
import type { NxcConfig, NxcProviderConfig, RateLimitRetryPolicy } from "../types";
import { resolveProviderTransport, type NxcProviderTransport } from "./xai-transport";
 ...
 */
export function hasKeyPoolFailover(provider: NxcProviderConfig): boolean {
...
export function rateLimitRetryPolicyFor(
  provider: Pick<NxcProviderConfig, "retryOn429" | "authMode">,
 ...
 *
 * @returns A new NxcProviderConfig with the swapped key (and mutated config on disk),
...
export function rotateProviderTransportOn429(
  config: NxcConfig,
  providerName: string,
  routedProvider: NxcProviderTransport,
  options: RotateProviderTransportOptions = {},
): NxcProviderTransport | null {
