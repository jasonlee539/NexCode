...
function buildFastPolicyAuthority(
  ...
  const authority: FastPolicyAuthority = Object.freeze({
    ...
    ...(registry?.fastTierDescription !== undefined
      ...
      : {}),
    modelWireOverrideAllowed: !isCanonicalOpenAiForwardProvider(provider as NxcProviderConfig),
    authTransport,
...
export function supportsServiceTierForModel(
  provider: Pick<NxcProviderConfig, "supportsServiceTier" | "modelSupportsServiceTier">,
  modelId: string,
): boolean | undefined {
...
export function canForwardForeignServiceTierForChatModel(
  provider: Pick<NxcProviderConfig, "supportsServiceTier" | "modelSupportsServiceTier" | "chatServiceTier">,
  modelId: string,
): boolean {
