...
export interface SidecarAuthState {
  ...
  anthropicProvider?: NxcProviderConfig;
}
...
function hasUsableCodexLogin(config: NxcConfig): boolean {
...
function findAnthropicAuthProvider(
  config: NxcConfig,
): { providerName: string; provider: NxcProviderConfig } | undefined {
...
export function resolveSidecarAuth(config: NxcConfig): SidecarAuthState {
