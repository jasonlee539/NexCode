...
let liveServerConfig: NxcConfig | null = null;

export function setLiveStateStoreConfig(config: NxcConfig): void {
...
export const STATE_STORE_REGISTRATIONS = [
  ...
  { name: "nxc-start-process-cache", sweepLiveness: sweepDeadNxcStartProcessCache },
