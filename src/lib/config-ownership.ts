...
export const CONFIG_OWNER_FILE = ".nexcode-owner.json";
export const CONFIG_UNINSTALL_MANIFEST = ".nexcode-uninstall.json";
...
const INITIAL_OWNED_PATHS = [
  ...
  "mimo-client-id",
  "nxc.pid",
  "nexcode-service-launcher.vbs",
  "nexcode-service-task.xml",
  "nexcode-service.cmd",
