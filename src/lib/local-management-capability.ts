...
export const LOCAL_MANAGEMENT_EXPECTED_PID_HEADER = "x-nexcode-local-expected-pid";
export const LOCAL_MANAGEMENT_NONCE_HEADER = "x-nexcode-local-nonce";
export const LOCAL_MANAGEMENT_CAPABILITY_EXPIRES_AT_HEADER = "x-nexcode-local-expires-at";
export const LOCAL_MANAGEMENT_CAPABILITY_HEADER = "x-nexcode-local-capability";
...
function localReadCapabilityPayload(
  ...
  return `nexcode-local-management-read-v1\n${nonce}\n${method}\n${path}\n${pid}\n${port}\n${expiresAt}`;
}
