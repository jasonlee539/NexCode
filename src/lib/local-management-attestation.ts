...
export const LOCAL_ATTESTATION_CHALLENGE_HEADER = "x-nexcode-attestation-challenge";
export const LOCAL_ATTESTATION_PROOF_HEADER = "x-nexcode-attestation-proof";
...
function attestationPayload(challenge: string, pid: number, port: number): string | null {
  ...
  return `nexcode-local-management-v1\n${challenge}\n${pid}\n${port}`;
}
