...
export function providerSecureTransportConfigError(
  name: string,
  provider: Pick<NxcProviderConfig, "baseUrl" | "allowPrivateNetwork">,
): string | null {
...
export function providerAllowsPrivateNetwork(
  name: string,
  provider: Pick<NxcProviderConfig, "allowPrivateNetwork">,
): boolean {
  return provider.allowPrivateNetwork === true || registryAllowsPrivateNetwork(name);
}

export function providerDestinationConfigError(name: string, provider: Pick<NxcProviderConfig, "baseUrl" | "allowPrivateNetwork">): string | null {
...
export function assertProviderDestinationAllowed(name: string, provider: Pick<NxcProviderConfig, "baseUrl" | "allowPrivateNetwork">): void {
