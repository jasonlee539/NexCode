...
type ProviderOutboundConfig = Pick<NxcProviderConfig, "baseUrl" | "allowPrivateNetwork"> & {
...
function warnProxyBoundaryOnce(): void {
  ...
  console.warn(
    "[nexcode] Provider outbound proxy mode preserves Bun proxy/NO_PROXY routing and validates "
...
function warnProxyDnsDegradationOnce(): void {
  ...
  console.warn(
    "[nexcode] Local DNS could not resolve a proxied provider hostname; continuing after URL/literal checks. "
