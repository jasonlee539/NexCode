...
export const LOCAL_PROVIDER_RELOAD_EXPECTED_PID_HEADER = "x-nexcode-provider-reload-expected-pid";
export const LOCAL_PROVIDER_RELOAD_NONCE_HEADER = "x-nexcode-provider-reload-nonce";
export const LOCAL_PROVIDER_RELOAD_EXPIRES_AT_HEADER = "x-nexcode-provider-reload-expires-at";
export const LOCAL_PROVIDER_RELOAD_NAME_HEADER = "x-nexcode-provider-reload-name";
export const LOCAL_PROVIDER_RELOAD_CAPABILITY_HEADER = "x-nexcode-provider-reload-capability";
...
function capabilityPayload(
  ...
  return `nexcode-local-provider-reload-v1\n${nonce}\n${method}\n${path}\n${name}\n${pid}\n${port}\n${expiresAt}`;
}
