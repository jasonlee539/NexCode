...
export const SYSTEM_RESTART_EXPECTED_PID_HEADER = "x-nexcode-restart-expected-pid";
export const SYSTEM_RESTART_NONCE_HEADER = "x-nexcode-restart-nonce";
export const SYSTEM_RESTART_CAPABILITY_HEADER = "x-nexcode-restart-capability";
...
function restartCapabilityPayload(
  ...
  return `nexcode-system-restart-v1\n${nonce}\n${method}\n${path}\n${pid}\n${port}`;
}
