export interface NxcErrorPayload {
  message: string;
  type: string;
  code: string | null;
}
...
export function classifyError(status: number, type: string, message: string): NxcErrorPayload {
...
export function adapterFailureFromMessage(message: string): { httpStatus: number; error: NxcErrorPayload } {
