 ...
 */
export function configuredReasoningEfforts(provider: NxcProviderConfig, modelId: string): string[] | undefined {
 ...
 */
function healMappedTiers(provider: NxcProviderConfig, modelId: string, efforts: string[]): string[] {
...
export function reasoningEffortMapFor(provider: NxcProviderConfig, modelId: string): Record<string, string> | undefined {
 ...
 */
export function mapReasoningEffort(provider: NxcProviderConfig, modelId: string, requested: string | undefined): string | undefined {
