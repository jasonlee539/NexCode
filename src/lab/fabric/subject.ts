...
const SANDBOX_DOMAIN = "nxc-lab:fabric-sandbox-profile:v1";
const VERIFIER_DOMAIN = "nxc-lab:fabric-verifier-manifest:v1";
const FIXTURE_DOMAIN = "nxc-lab:fabric-task-fixture:v1";
