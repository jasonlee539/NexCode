...
export function buildRouteSubjectV1(
  ...
  if (!/^[0-9a-f]{64}$/.test(routeContext.nexcodeCompatibilityVersion)) {
    throw new Error("harness_failure: invalid nexcodeCompatibilityVersion");
  }
  ...
  const subject: RouteSubjectV1 = {
    ...
    nexcodeCompatibilityVersion: routeContext.nexcodeCompatibilityVersion,
