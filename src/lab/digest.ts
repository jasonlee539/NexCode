...
export const LAB_DOMAIN = {
  event: "nxc-lab:event:v1",
  subject: "nxc-lab:subject:v1",
  claimSourceManifest: "nxc-lab:claim-source-manifest:v1",
  scenarioManifest: "nxc-lab:scenario-manifest:v1",
  suiteManifest: "nxc-lab:suite-manifest:v1",
  fixture: "nxc-lab:fixture:v1",
  localFingerprint: "nxc-lab:local-fingerprint:v1",
  artifactBytes: "nxc-lab:artifact-bytes:v1",
} as const;
