...
When adding or redesigning a GUI page, CLI wizard, or user-facing flow in nexcode,
...
This is a design-first rule for contributors, not a runtime feature: nexcode is infrastructure
...
| `nxc init` CLI | Flat numbered menu, no personality | Could benefit from staged approach |
