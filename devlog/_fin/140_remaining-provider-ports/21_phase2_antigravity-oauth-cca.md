...
```
ClientID         <set GOOGLE_ANTIGRAVITY_CLIENT_ID>
ClientSecret     <set GOOGLE_ANTIGRAVITY_CLIENT_SECRET>
CallbackPort     51121
...
> OAuth client credentials are intentionally not committed. Supply them through
